        ...
        final ?? r1 = new OnContextAvailableListener() { // from class: androidx.activity.contextaware.ContextAwareKt$withContextAvailable$2$listener$1
            ...
            public void onContextAvailable(@NotNull Context context) {
                ...
                try {
                    ...
                    m8512constructorimpl = Result.m8512constructorimpl(function12.invoke(context));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m8512constructorimpl = Result.m8512constructorimpl(ResultKt.createFailure(th));
                }
                cancellableContinuationImpl.resumeWith(m8512constructorimpl);
            }
        };
