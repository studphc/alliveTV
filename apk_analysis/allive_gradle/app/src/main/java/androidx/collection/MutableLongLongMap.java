...
public final class MutableLongLongMap extends LongLongMap {
    ...
    public final int m381b(long j) {
        ...
        while (true) {
            ...
            if ((((~j2) << 6) & j2 & (-9187201950435737472L)) != 0) {
                ...
                if (this.f1717a == 0) {
                    long j6 = 254;
                    if (((this.metadata[m380a >> 3] >> ((m380a & 7) << 3)) & 255) != 254) {
                        if (this._capacity > 8) {
                        ...
                        m383d(ScatterMapKt.nextCapacity(this._capacity));
                        m380a = m380a(i4);
                    }
                }
                this._size++;
    ...
    public final void m382c(int i) {
        ...
        long j = 255 << ((i2 & 7) << 3);
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f1717a = ScatterMapKt.loadedCapacity(get_capacity()) - this._size;
    ...
    public final void m383d(int i) {
        ...
        while (i3 < i2) {
            if (((jArr3[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                ...
                jArr = jArr3;
                jArr2 = jArr4;
                jArr8[i6] = (jArr8[i6] & (~(255 << i7))) | (j2 << i7);
                int i8 = this._capacity;
                int i9 = ((m380a - 7) & i8) + (i8 & 7);
                int i10 = i9 >> 3;
                int i11 = (i9 & 7) << 3;
                jArr8[i10] = (jArr8[i10] & (~(255 << i11))) | (j2 << i11);
                jArr6[m380a] = j;
                jArr7[m380a] = jArr5[i3];
            } else {
                jArr = jArr3;
                jArr2 = jArr4;
            }
    ...
    public MutableLongLongMap(int i) {
        super(null);
        if (i >= 0) {
            m382c(ScatterMapKt.unloadedCapacity(i));
            return;
        }
