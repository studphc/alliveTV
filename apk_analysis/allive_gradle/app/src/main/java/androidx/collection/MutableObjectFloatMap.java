...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
    ...
    /* renamed from: b */
    public final int m394b(Object obj) {
        int i;
        long j;
        int i2;
        long[] jArr;
        ...
        while (true) {
            ...
            if ((((~j3) << 6) & j3 & (-9187201950435737472L)) != 0) {
                int m393a = m393a(i6);
                if (this.f1720a != 0 || ((this.metadata[m393a >> 3] >> ((m393a & 7) << 3)) & 255) == 254) {
                    j = j4;
                } else {
                    if (this._capacity > 8) {
                    ...
                    j = j4;
                    m396d(ScatterMapKt.nextCapacity(this._capacity));
                    m393a = m393a(i6);
                }
                this._size++;
                int i23 = this.f1720a;
    ...
    public final void m395c(int i) {
        ...
        long j = 255 << ((i2 & 7) << 3);
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f1720a = ScatterMapKt.loadedCapacity(get_capacity()) - this._size;
    ...
    public MutableObjectFloatMap(int i) {
        super(null);
        if (i >= 0) {
            m395c(ScatterMapKt.unloadedCapacity(i));
            return;
        }
