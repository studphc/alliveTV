...
public final class MetadataItem extends Table {
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem metadataItem, int i) {
            return metadataItem.__assign(Table.__indirect(__element(i), this.f4244bb), this.f4244bb);
        }
    }
    ...
    public int codepoints(int i) {
        ...
        if (__offset != 0) {
            return this.f4285bb.getInt((i * 4) + __vector(__offset));
        }
        return 0;
    }
    ...
    public short compatAdded() {
        ...
        if (__offset != 0) {
            return this.f4285bb.getShort(__offset + this.bb_pos);
        }
        return (short) 0;
    }
    ...
    public boolean emojiStyle() {
        ...
        if (__offset == 0 || this.f4285bb.get(__offset + this.bb_pos) == 0) {
            return false;
        }
        return true;
    }
    ...
    public int m1080id() {
        ...
        if (__offset != 0) {
            return this.f4285bb.getInt(__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector intVector) {
        int __offset = __offset(16);
        if (__offset != 0) {
            return intVector.__assign(__vector(__offset), this.f4285bb);
        }
        return null;
    }
}
