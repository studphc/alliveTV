...
public final class Util {
    ...
    /* renamed from: a */
    public static final Pattern f12775a;

    /* renamed from: b */
    public static final Pattern f12776b;

    /* renamed from: c */
    public static final Pattern f12777c;

    /* renamed from: d */
    public static final Pattern f12778d;

    /* renamed from: e */
    public static HashMap f12779e;
    ...
    /* renamed from: h */
    public static final int[] f12782h;

    /* renamed from: i */
    public static final int[] f12783i;
    ...
    static {
        ...
        f12775a = Pattern.compile("(\\d\\d\\d\\d)\\-(\\d\\d)\\-(\\d\\d)[Tt](\\d\\d):(\\d\\d):(\\d\\d)([\\.,](\\d+))?([Zz]|((\\+|\\-)(\\d?\\d):?(\\d\\d)))?");
        f12776b = Pattern.compile("^(-)?P(([0-9]*)Y)?(([0-9]*)M)?(([0-9]*)D)?(T(([0-9]*)H)?(([0-9]*)M)?(([0-9.]*)S)?)?$");
        f12777c = Pattern.compile("%([A-Fa-f0-9]{2})");
        f12778d = Pattern.compile("(?:.*\\.)?isml?(?:/(manifest(.*))?)?", 2);
        f12780f = new String[]{"alb", "sq", "arm", "hy", "baq", "eu", "bur", "my", "tib", "bo", "chi", "zh", "cze", "cs", "dut", "nl", "ger", "de", "gre", "el", "fre", "fr", "geo", "ka", "ice", "is", "mac", "mk", "mao", "mi", "may", "ms", "per", "fa", "rum", "ro", "scc", "hbs-srp", "slo", "sk", "wel", "cy", "id", "ms-ind", "iw", "he", "heb", "he", "ji", "yi", "arb", "ar-arb", "in", "ms-ind", "ind", "ms-ind", "nb", "no-nob", "nob", "no-nob", "nn", "no-nno", "nno", "no-nno", "tw", "ak-twi", "twi", "ak-twi", "bs", "hbs-bos", "bos", "hbs-bos", "hr", "hbs-hrv", "hrv", "hbs-hrv", "sr", "hbs-srp", "srp", "hbs-srp", "cmn", "zh-cmn", "hak", "zh-hak", "nan", "zh-nan", "hsn", "zh-hsn"};
        f12781g = new String[]{"i-lux", "lb", "i-hak", "zh-hak", "i-navajo", "nv", "no-bok", "no-nob", "no-nyn", "no-nno", "zh-guoyu", "zh-cmn", "zh-hakka", "zh-hak", "zh-min-nan", "zh-nan", "zh-xiang", "zh-hsn"};
        f12782h = new int[]{0, 79764919, 159529838, 222504665, 319059676, 398814059, 445009330, 507990021, 638119352, 583659535, 797628118, 726387553, 890018660, 835552979, 1015980042, 944750013, 1276238704, 1221641927, 1167319070, 1095957929, 1595256236, 1540665371, 1452775106, 1381403509, 1780037320, 1859660671, 1671105958, 1733955601, 2031960084, 2111593891, 1889500026, 1952343757, -1742489888, -1662866601, -1851683442, -1788833735, -1960329156, -1880695413, -2103051438, -2040207643, -1104454824, -1159051537, -1213636554, -1284997759, -1389417084, -1444007885, -1532160278, -1603531939, -734892656, -789352409, -575645954, -646886583, -952755380, -1007220997, -827056094, -898286187, -231047128,
 147, 148, 157, 154, 39, 32, 41, 46, 59, 60, 53, 50, 31, 24, 17, 22, 3, 4, 13, 10, 87, 80, 89, 94, 75, 76, 69, 66, 111, 104, 97, 102, 115, 116, 125, 122, 137, 142, TsExtractor.TS_STREAM_TYPE_E_AC3, 128, 149, 146, 155, 156, 177, 182, 191, 184, 173, 170, 163, 164, 249, 254, 247, PsExtractor.VIDEO_STREAM_MASK, 229, HttpStatusCodesKt.HTTP_IM_USED, 235, 236, 193, 198, HttpStatusCodesKt.HTTP_MULTI_STATUS, 200, 221, 218, 211, 212, 105, 110, 103, 96, 117, 114, 123, 124, 81, 86, 95, 88, 77, 74, 67, 68, 25, 30, 23, 16, 5, 2, 11, 12, 33, 38, 47, 40, 61, 58, 51, 52, 78, 73, 64, 71, 82, 85, 92, 91, 118, 113, 120, 127, 106, 109, 100, 99, 62, 57, 48, 55, 34, 37, 44, 43, 6, 1, 8, 15, 26, 29, 20, 19, 174, 169, 160, 167, 178, 181, TsExtractor.TS_PACKET_SIZE, 187, 150, 145, 152, 159, TsExtractor.TS_STREAM_TYPE_DTS, ModuleDescriptor.MODULE_VERSION, 132, 131, 222, 217, HttpStatusCodesKt.HTTP_ALREADY_REPORTED, 215, 194, 197, HttpStatusCodesKt.HTTP_NO_CONTENT, HttpStatusCodesKt.HTTP_NOT_AUTHORITATIVE, 230, 225, 232, 239, ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, 253, 244, 243};
    }

    /* renamed from: a */
    public static String m3048a(String str) {
        try {
            Class<?> cls = Class.forName("android.os.SystemProperties");
            return (String) cls.getMethod("get", String.class).invoke(cls, str);
        } catch (Exception e) {
            Log.m3024e("Util", "Failed to read system property ".concat(str), e);
            return null;
        }
    }
    ...
    /* renamed from: b */
    public static boolean m3049b(Uri uri) {
        if ("http".equals(uri.getScheme()) && !go2.m4974o(NetworkSecurityPolicy.getInstance(), (String) Assertions.checkNotNull(uri.getHost()))) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: c */
    public static boolean m3050c(Activity activity, Uri uri) {
        if (SDK_INT < 23) {
            return false;
        }
    ...
    public static boolean checkCleartextTrafficPermitted(MediaItem... mediaItemArr) {
        ...
        for (MediaItem mediaItem : mediaItemArr) {
            ...
            if (localConfiguration != null) {
                if (m3049b(localConfiguration.uri)) {
                    return false;
                }
                for (int i = 0; i < mediaItem.localConfiguration.subtitleConfigurations.size(); i++) {
                    if (m3049b(mediaItem.localConfiguration.subtitleConfigurations.get(i).uri)) {
                        return false;
                    }
                }
            }
    ...
    public static int crc32(byte[] bArr, int i, int i2, int i3) {
        while (i < i2) {
            i3 = f12782h[((i3 >>> 24) ^ (bArr[i] & 255)) & 255] ^ (i3 << 8);
            i++;
        }
        return i3;
    }
    ...
    /* renamed from: d */
    public static boolean m3051d(char c) {
    ...
    public static Uri fixSmoothStreamingIsmManifestUri(Uri uri) {
        ...
        Matcher matcher = f12778d.matcher(path);
    ...
    public static Uri getDataUriForString(String str, String str2) {
        StringBuilder m7065u = AbstractC1726qj.m7065u("data:", str, ";base64,");
        m7065u.append(Base64.encodeToString(str2.getBytes(), 2));
        return Uri.parse(m7065u.toString());
    }

    public static Locale getDefaultDisplayLocale() {
        if (SDK_INT >= 24) {
            return go2.m4964e(go2.m4963d());
        }
    ...
    public static UUID getDrmUuid(String str) {
        ...
        switch (c) {
            case 0:
                return C0643C.PLAYREADY_UUID;
            case 1:
                return C0643C.WIDEVINE_UUID;
            case 2:
                return C0643C.CLEARKEY_UUID;
            default:
                try {
    ...
    public static int getPcmEncoding(int i) {
        ...
        return C0643C.ENCODING_PCM_32BIT;
    }
    ...
    public static String[] getSystemLanguageCodes() {
        ...
        if (SDK_INT >= 24) {
            strArr = split(AbstractC1608o3.m6422j(AbstractC1608o3.m6419g(configuration)), ",");
        } else {
            strArr = new String[]{getLocaleLanguageTag(configuration.locale)};
        }
        for (int i = 0; i < strArr.length; i++) {
            strArr[i] = normalizeLanguageCode(strArr[i]);
        }
        return strArr;
    }
    ...
    public static String getUserAgent(Context context, String str) {
        ...
        return AbstractC1726qj.m7061q(sb, Build.VERSION.RELEASE, ") ExoPlayerLib/2.18.1");
    }
    ...
    public static long msToUs(long j) {
        return (j == C0643C.TIME_UNSET || j == Long.MIN_VALUE) ? j : j * 1000;
    }

    public static ExecutorService newSingleThreadExecutor(String str) {
        return Executors.newSingleThreadExecutor(new ThreadFactoryC1737qu(str, 1));
    }
    ...
    public static String normalizeLanguageCode(String str) {
        ...
        if (!replace.isEmpty() && !replace.equals(C0643C.LANGUAGE_UNDETERMINED)) {
            str = replace;
        }
        String lowerCase = Ascii.toLowerCase(str);
        int i = 0;
        ...
        String str4 = (String) f12779e.get(str2);
        if (str4 != null) {
            StringBuilder m7064t = AbstractC1726qj.m7064t(str4);
            m7064t.append(lowerCase.substring(str2.length()));
            lowerCase = m7064t.toString();
            str2 = str4;
        }
    ...
    public static long parseXsDateTime(String str) {
        Matcher matcher = f12775a.matcher(str);
        if (matcher.matches()) {
            int i = 0;
    ...
    public static long parseXsDuration(String str) {
        ...
        double d4;
        double d5;
        Matcher matcher = f12776b.matcher(str);
        if (matcher.matches()) {
    ...
    public static ComponentName startForegroundService(Context context, Intent intent) {
        if (SDK_INT >= 26) {
            return r32.m7194f(context, intent);
        }
    ...
    public static String toHexString(byte[] bArr) {
        ...
        for (int i = 0; i < bArr.length; i++) {
            ...
            sb.append(Character.forDigit(bArr[i] & Ascii.f14464SI, 16));
        }
        return sb.toString();
    }
    ...
    public static String unescapeFileName(String str) {
        ...
        Matcher matcher = f12777c.matcher(str);
    ...
    public static long usToMs(long j) {
        if (j != C0643C.TIME_UNSET && j != Long.MIN_VALUE) {
            return j / 1000;
        }
        return j;
    }
    ...
    public static int inferContentType(Uri uri) {
        ...
        Matcher matcher = f12778d.matcher((CharSequence) Assertions.checkNotNull(uri.getPath()));
        if (!matcher.matches()) {
            return 4;
        }
    ...
    public static Point getCurrentDisplayModeSize(Context context, Display display) {
        ...
        if (display.getDisplayId() == 0 && isTv(context)) {
            if (SDK_INT < 28) {
                m3048a = m3048a("sys.display-size");
            } else {
                m3048a = m3048a("vendor.display-size");
            }
            if (!TextUtils.isEmpty(m3048a)) {
                try {
                    String[] split = split(m3048a.trim(), "x");
                    if (split.length == 2) {
                ...
                Log.m3023e("Util", "Invalid display size: " + m3048a);
            }
