...
public class SafeParcelReader {
    ...
    /* renamed from: a */
    public static void m3153a(Parcel parcel, int i, int i2) {
        if (i == i2) {
            return;
        }
        throw new ParseException(AbstractC1726qj.m7061q(ye0.m8302v("Expected size ", i2, " got ", i, " (0x"), Integer.toHexString(i), ")"), parcel);
    }

    /* renamed from: b */
    public static void m3154b(Parcel parcel, int i, int i2) {
        int readSize = readSize(parcel, i);
        if (readSize == i2) {
            return;
        }
        throw new ParseException(AbstractC1726qj.m7061q(ye0.m8302v("Expected size ", i2, " got ", readSize, " (0x"), Integer.toHexString(readSize), ")"), parcel);
    }
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i) {
        if (parcel.dataPosition() == i) {
            ...
            throw new ParseException(ye0.m8291k(i, "Overread allowed size end="), parcel);
        }
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (fieldId == 20293) {
            ...
            throw new ParseException(ye0.m8293m(dataPosition, "Size read is invalid start=", " end=", i), parcel);
        }
