...
public class SafeParcelWriter {
    /* renamed from: a */
    public static int m3155a(Parcel parcel, int i) {
    ...
    /* renamed from: b */
    public static void m3156b(Parcel parcel, int i) {
    ...
    public static int beginObjectHeader(@NonNull Parcel parcel) {
        return m3155a(parcel, 20293);
    }

    /* renamed from: c */
    public static void m3157c(Parcel parcel, int i, int i2) {
        parcel.writeInt(i | (i2 << 16));
    }

    /* renamed from: d */
    public static void m3158d(Parcel parcel, Parcelable parcelable, int i) {
        int dataPosition = parcel.dataPosition();
        parcel.writeInt(1);
    ...
    public static void writeBigDecimal(@NonNull Parcel parcel, int i, @NonNull BigDecimal bigDecimal, boolean z) {
        if (bigDecimal == null) {
            ...
            int m3155a = m3155a(parcel, i);
            parcel.writeByteArray(bigDecimal.unscaledValue().toByteArray());
            parcel.writeInt(bigDecimal.scale());
            m3156b(parcel, m3155a);
        }
    }
