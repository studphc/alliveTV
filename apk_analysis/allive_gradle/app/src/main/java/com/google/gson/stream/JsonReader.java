...
public class JsonReader implements Closeable {
    ...
    */
    ...
    private IOException syntaxError(String str) {
        ...
        m7064t.append(locationString());
        throw new MalformedJsonException(m7064t.toString());
    }
    ...
    public String locationString() {
        StringBuilder m8302v = ye0.m8302v(" at line ", this.lineNumber + 1, " column ", (this.pos - this.lineStart) + 1, " path ");
        m8302v.append(getPath());
        return m8302v.toString();
    }
