...
public final class GlideOptions extends RequestOptions implements Cloneable {
    ...
    /* renamed from: I */
    public static GlideOptions f15828I;

    /* renamed from: J */
    public static GlideOptions f15829J;

    /* renamed from: K */
    public static GlideOptions f15830K;

    /* renamed from: L */
    public static GlideOptions f15831L;

    /* renamed from: M */
    public static GlideOptions f15832M;

    /* renamed from: N */
    public static GlideOptions f15833N;
    ...
    public static GlideOptions centerCropTransform() {
        if (f15830K == null) {
            f15830K = new GlideOptions().centerCrop().autoClone();
        }
        return f15830K;
    }
    ...
    public static GlideOptions centerInsideTransform() {
        if (f15829J == null) {
            f15829J = new GlideOptions().centerInside().autoClone();
        }
        return f15829J;
    }
    ...
    public static GlideOptions circleCropTransform() {
        if (f15831L == null) {
            f15831L = new GlideOptions().circleCrop().autoClone();
        }
        return f15831L;
    }
    ...
    @NonNull
    @CheckResult
    public static GlideOptions encodeQualityOf(@IntRange(from = 0, m153to = 100) int i) {
    ...
    public static GlideOptions fitCenterTransform() {
        if (f15828I == null) {
            f15828I = new GlideOptions().fitCenter().autoClone();
        }
        return f15828I;
    }
    ...
    public static GlideOptions noAnimation() {
        if (f15833N == null) {
            f15833N = new GlideOptions().dontAnimate().autoClone();
        }
        return f15833N;
    }
    ...
    public static GlideOptions noTransformation() {
        if (f15832M == null) {
            f15832M = new GlideOptions().dontTransform().autoClone();
        }
        return f15832M;
    }
    ...
    @NonNull
    @CheckResult
    public static GlideOptions sizeMultiplierOf(@FloatRange(from = 0.0d, m152to = 1.0d) float f) {
    ...
    @NonNull
    @CheckResult
    public RequestOptions encodeQuality(@IntRange(from = 0, m153to = 100) int i) {
    ...
    @NonNull
    @CheckResult
    public RequestOptions sizeMultiplier(@FloatRange(from = 0.0d, m152to = 1.0d) float f) {
    ...
    public RequestOptions mo8485clone() {
        return (GlideOptions) super.mo8485clone();
    }
