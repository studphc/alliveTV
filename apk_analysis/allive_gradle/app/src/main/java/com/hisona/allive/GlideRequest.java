...
public class GlideRequest<TranscodeType> extends RequestBuilder<TranscodeType> implements Cloneable {
    ...
    @NonNull
    @CheckResult
    public GlideRequest<TranscodeType> encodeQuality(@IntRange(from = 0, m153to = 100) int i) {
    ...
    public GlideRequest<File> getDownloadOnlyRequest() {
        return new RequestBuilder(File.class, this).apply((BaseRequestOptions<?>) RequestBuilder.DOWNLOAD_ONLY_OPTIONS);
    }
    ...
    @NonNull
    @CheckResult
    public GlideRequest<TranscodeType> sizeMultiplier(@FloatRange(from = 0.0d, m152to = 1.0d) float f) {
    ...
    @CheckResult
    /* renamed from: clone */
    public GlideRequest<TranscodeType> mo8485clone() {
        return (GlideRequest) super.mo8485clone();
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<TranscodeType> mo8491load(@Nullable Object obj) {
        return (GlideRequest) super.mo8491load(obj);
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<TranscodeType> mo8486load(@Nullable Bitmap bitmap) {
        return (GlideRequest) super.mo8486load(bitmap);
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<TranscodeType> mo8487load(@Nullable Drawable drawable) {
        return (GlideRequest) super.mo8487load(drawable);
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<TranscodeType> mo8492load(@Nullable String str) {
        return (GlideRequest) super.mo8492load(str);
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<TranscodeType> mo8488load(@Nullable Uri uri) {
        return (GlideRequest) super.mo8488load(uri);
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<TranscodeType> mo8489load(@Nullable File file) {
        return (GlideRequest) super.mo8489load(file);
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<TranscodeType> mo8490load(@Nullable @DrawableRes @RawRes Integer num) {
        return (GlideRequest) super.mo8490load(num);
    }
    ...
    @Deprecated
    /* renamed from: load */
    public GlideRequest<TranscodeType> mo8493load(@Nullable URL url) {
        return (GlideRequest) super.mo8493load(url);
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<TranscodeType> mo8494load(@Nullable byte[] bArr) {
        return (GlideRequest) super.mo8494load(bArr);
    }
}
