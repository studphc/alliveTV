...
public abstract class Completable implements CompletableSource {
    ...
    /* renamed from: b */
    public static Completable m5251b(Publisher publisher, int i, boolean z) {
    ...
    /* renamed from: a */
    public final Completable m5252a(Consumer consumer, Consumer consumer2, Action action, Action action2, Action action3, Action action4) {
    ...
    /* renamed from: c */
    public final Completable m5253c(long j, TimeUnit timeUnit, Scheduler scheduler, CompletableSource completableSource) {
    ...
    public final Completable doAfterTerminate(@NonNull Action action) {
        ...
        return m5252a(emptyConsumer, emptyConsumer2, action2, action2, action, action2);
    }
    ...
    public final Completable doOnComplete(@NonNull Action action) {
        ...
        Consumer emptyConsumer2 = Functions.emptyConsumer();
        Action action2 = Functions.EMPTY_ACTION;
        return m5252a(emptyConsumer, emptyConsumer2, action, action2, action2, action2);
    }
    ...
    public final Completable doOnDispose(@NonNull Action action) {
        ...
        Consumer emptyConsumer2 = Functions.emptyConsumer();
        Action action2 = Functions.EMPTY_ACTION;
        return m5252a(emptyConsumer, emptyConsumer2, action2, action2, action2, action);
    }
    ...
    public final Completable doOnError(@NonNull Consumer<? super Throwable> consumer) {
        ...
        return m5252a(emptyConsumer, consumer, action, action, action, action);
    }
    ...
    public final Completable doOnLifecycle(@NonNull Consumer<? super Disposable> consumer, @NonNull Action action) {
        Consumer emptyConsumer = Functions.emptyConsumer();
        Action action2 = Functions.EMPTY_ACTION;
        return m5252a(consumer, emptyConsumer, action2, action2, action2, action);
    }
    ...
    public final Completable doOnSubscribe(@NonNull Consumer<? super Disposable> consumer) {
        Consumer emptyConsumer = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return m5252a(consumer, emptyConsumer, action, action, action, action);
    }
    ...
    public final Completable doOnTerminate(@NonNull Action action) {
        ...
        Consumer emptyConsumer2 = Functions.emptyConsumer();
        Action action2 = Functions.EMPTY_ACTION;
        return m5252a(emptyConsumer, emptyConsumer2, action2, action, action2, action2);
    }
    ...
    public final Completable timeout(long j, @NonNull TimeUnit timeUnit) {
        return m5253c(j, timeUnit, Schedulers.computation(), null);
    }

    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    /* renamed from: to */
    public final <R> R m5254to(@NonNull CompletableConverter<? extends R> completableConverter) {
    ...
    public final <T> CompletionStage<T> toCompletionStage(T t) {
        return AbstractC1608o3.m6427o(subscribeWith(new CompletionStageConsumer(true, t)));
    }
    ...
    public final Completable timeout(long j, @NonNull TimeUnit timeUnit, @NonNull CompletableSource completableSource) {
        Objects.requireNonNull(completableSource, "fallback is null");
        return m5253c(j, timeUnit, Schedulers.computation(), completableSource);
    }
    ...
    public static Completable merge(@NonNull Publisher<? extends CompletableSource> publisher) {
        return m5251b(publisher, Integer.MAX_VALUE, false);
    }
    ...
    public static Completable mergeDelayError(@NonNull Publisher<? extends CompletableSource> publisher) {
        return m5251b(publisher, Integer.MAX_VALUE, true);
    }
    ...
    public static Completable merge(@NonNull Publisher<? extends CompletableSource> publisher, int i) {
        return m5251b(publisher, i, false);
    }
    ...
    public static Completable mergeDelayError(@NonNull Publisher<? extends CompletableSource> publisher, int i) {
        return m5251b(publisher, i, true);
    }
    ...
    public final Completable timeout(long j, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler) {
        return m5253c(j, timeUnit, scheduler, null);
    }
    ...
    public final Completable timeout(long j, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler, @NonNull CompletableSource completableSource) {
        Objects.requireNonNull(completableSource, "fallback is null");
        return m5253c(j, timeUnit, scheduler, completableSource);
    }
