...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public static <T> Observable<T> fromOptional(@NonNull Optional<T> optional) {
        ...
        map = optional.map(new li0(2));
        orElseGet = map.orElseGet(new mi0(2));
        return (Observable) orElseGet;
    }
    ...
    /* renamed from: a */
    public final Observable m5261a(Consumer consumer, Consumer consumer2, Action action, Action action2) {
    ...
    /* renamed from: b */
    public final Observable m5262b(long j, TimeUnit timeUnit, Scheduler scheduler, ObservableSource observableSource) {
    ...
    /* renamed from: c */
    public final Observable m5263c(ObservableSource observableSource, Function function, ObservableSource observableSource2) {
    ...
    public final Observable<T> doAfterTerminate(@NonNull Action action) {
        ...
        return m5261a(Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.EMPTY_ACTION, action);
    }
    ...
    public final Observable<T> doOnComplete(@NonNull Action action) {
        return m5261a(Functions.emptyConsumer(), Functions.emptyConsumer(), action, Functions.EMPTY_ACTION);
    }
    ...
    public final Observable<T> doOnEach(@NonNull Consumer<? super Notification<T>> consumer) {
        ...
        return m5261a(Functions.notificationOnNext(consumer), Functions.notificationOnError(consumer), Functions.notificationOnComplete(consumer), Functions.EMPTY_ACTION);
    }
    ...
    public final Observable<T> doOnError(@NonNull Consumer<? super Throwable> consumer) {
        ...
        return m5261a(emptyConsumer, consumer, action, action);
    }
    ...
    public final Observable<T> doOnNext(@NonNull Consumer<? super T> consumer) {
        Consumer emptyConsumer = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return m5261a(consumer, emptyConsumer, action, action);
    }
    ...
    public final Observable<T> doOnTerminate(@NonNull Action action) {
        ...
        return m5261a(Functions.emptyConsumer(), Functions.actionConsumer(action), action, Functions.EMPTY_ACTION);
    }
    ...
    public final CompletionStage<T> firstOrErrorStage() {
        return uk1.m7720j(subscribeWith(new ObservableFirstStageObserver(false, null)));
    }
    ...
    public final CompletionStage<T> firstStage(@Nullable T t) {
        return uk1.m7720j(subscribeWith(new ObservableFirstStageObserver(true, t)));
    }
    ...
    public final CompletionStage<T> lastOrErrorStage() {
        return uk1.m7720j(subscribeWith(new ObservableLastStageObserver(false, null)));
    }
    ...
    public final CompletionStage<T> lastStage(@Nullable T t) {
        return uk1.m7720j(subscribeWith(new ObservableLastStageObserver(true, t)));
    }
    ...
    public final CompletionStage<T> singleOrErrorStage() {
        return uk1.m7720j(subscribeWith(new ObservableSingleStageObserver(false, null)));
    }
    ...
    public final CompletionStage<T> singleStage(@Nullable T t) {
        return uk1.m7720j(subscribeWith(new ObservableSingleStageObserver(true, t)));
    }
    ...
    public final <V> Observable<T> timeout(@NonNull Function<? super T, ? extends ObservableSource<V>> function) {
        return m5263c(null, function, null);
    }
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    /* renamed from: to */
    public final <R> R m5264to(@NonNull ObservableConverter<T, ? extends R> observableConverter) {
    ...
    public final Flowable<T> toFlowable(@NonNull BackpressureStrategy backpressureStrategy) {
        ...
        int i = jt1.f20624a[backpressureStrategy.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i != 4) {
    ...
    public final <V> Observable<T> timeout(@NonNull Function<? super T, ? extends ObservableSource<V>> function, @NonNull ObservableSource<? extends T> observableSource) {
        Objects.requireNonNull(observableSource, "fallback is null");
        return m5263c(null, function, observableSource);
    }
    ...
    public final Observable<T> timeout(long j, @NonNull TimeUnit timeUnit) {
        return m5262b(j, timeUnit, Schedulers.computation(), null);
    }
    ...
    public final Observable<T> timeout(long j, @NonNull TimeUnit timeUnit, @NonNull ObservableSource<? extends T> observableSource) {
        Objects.requireNonNull(observableSource, "fallback is null");
        return m5262b(j, timeUnit, Schedulers.computation(), observableSource);
    }
    ...
    public final Observable<T> doOnEach(@NonNull Observer<? super T> observer) {
        Objects.requireNonNull(observer, "observer is null");
        return m5261a(ObservableInternalHelper.observerOnNext(observer), ObservableInternalHelper.observerOnError(observer), ObservableInternalHelper.observerOnComplete(observer), Functions.EMPTY_ACTION);
    }
    ...
    public final Observable<T> timeout(long j, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler, @NonNull ObservableSource<? extends T> observableSource) {
        Objects.requireNonNull(observableSource, "fallback is null");
        return m5262b(j, timeUnit, scheduler, observableSource);
    }
    ...
    public final Observable<T> timeout(long j, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler) {
        return m5262b(j, timeUnit, scheduler, null);
    }
    ...
    public final <U, V> Observable<T> timeout(@NonNull ObservableSource<U> observableSource, @NonNull Function<? super T, ? extends ObservableSource<V>> function) {
        ...
        return m5263c(observableSource, function, null);
    }
    ...
    public final <U, V> Observable<T> timeout(@NonNull ObservableSource<U> observableSource, @NonNull Function<? super T, ? extends ObservableSource<V>> function, @NonNull ObservableSource<? extends T> observableSource2) {
        ...
        return m5263c(observableSource, function, observableSource2);
    }
