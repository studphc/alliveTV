...
public final class LambdaSubscriber<T> extends AtomicReference<Subscription> implements FlowableSubscriber<T>, Subscription, Disposable, LambdaConsumerIntrospection {
    ...
    /* renamed from: a */
    public final Consumer f19918a;

    /* renamed from: b */
    public final Consumer f19919b;

    /* renamed from: c */
    public final Action f19920c;

    /* renamed from: d */
    public final Consumer f19921d;
    ...
    public LambdaSubscriber(Consumer<? super T> consumer, Consumer<? super Throwable> consumer2, Action action, Consumer<? super Subscription> consumer3) {
        this.f19918a = consumer;
        this.f19919b = consumer2;
        this.f19920c = action;
        this.f19921d = consumer3;
    }
    ...
    public boolean hasCustomOnError() {
        if (this.f19919b != Functions.ON_ERROR_MISSING) {
            return true;
        }
        return false;
    }
