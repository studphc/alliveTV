...
public final class DispatchedTaskKt {
    ...
    public static final <T> void resume(@NotNull DispatchedTask<? super T> dispatchedTask, @NotNull Continuation<? super T> continuation, boolean z) {
        ...
        Object m8512constructorimpl = Result.m8512constructorimpl(successfulResult$kotlinx_coroutines_core);
        if (z) {
            ...
            try {
                dispatchedContinuation.continuation.resumeWith(m8512constructorimpl);
        ...
        continuation.resumeWith(m8512constructorimpl);
    }
