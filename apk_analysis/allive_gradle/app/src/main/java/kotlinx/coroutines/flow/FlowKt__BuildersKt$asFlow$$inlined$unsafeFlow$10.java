...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10 implements Flow<Long> {
    ...
    /* renamed from: a */
    public final /* synthetic */ LongRange f21546a;

    @Metadata(m5570k = 3, m5571mv = {1, 8, 0}, m5573xi = 48)
    @DebugMetadata(m5600c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10", m5601f = "Builders.kt", m5602i = {0}, m5603l = {116}, m5604m = "collect", m5605n = {"$this$asFlow_u24lambda_u2419"}, m5606s = {"L$0"})
    @SourceDebugExtension({"SMAP\nSafeCollector.common.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SafeCollector.common.kt\nkotlinx/coroutines/flow/internal/SafeCollector_commonKt$unsafeFlow$1$collect$1\n*L\n1#1,113:1\n*E\n"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10$1 */
    /* loaded from: classes2.dex */
    public static final class C14231 extends ContinuationImpl {
        ...
        /* renamed from: g */
        public FlowCollector f21550g;

        /* renamed from: h */
        public Iterator f21551h;

        public C14231(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(@NotNull FlowCollector<? super Long> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C14231) {
            ...
            int i2 = c14231.f21548e;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                c14231.f21548e = i2 - Integer.MIN_VALUE;
                Object obj = c14231.f21547d;
                Object coroutine_suspended = b51.getCOROUTINE_SUSPENDED();
                i = c14231.f21548e;
                if (i == 0) {
                    if (i == 1) {
                        it = c14231.f21551h;
                        FlowCollector flowCollector3 = c14231.f21550g;
                    ...
                    it = this.f21546a.iterator();
                }
                while (it.hasNext()) {
                    Long boxLong = Boxing.boxLong(((LongIterator) it).nextLong());
                    c14231.f21550g = flowCollector2;
                    c14231.f21551h = it;
                    c14231.f21548e = 1;
                    if (flowCollector2.emit(boxLong, c14231) == coroutine_suspended) {
