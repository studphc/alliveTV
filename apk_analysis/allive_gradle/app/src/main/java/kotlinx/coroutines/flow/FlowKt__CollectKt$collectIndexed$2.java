...
@Metadata(m5568d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u001b\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0002\u001a\u00028\u0000H\u0096@ø\u0001\u0000¢\u0006\u0004\b\u0004\u0010\u0005\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u0006"}, m5569d2 = {"kotlinx/coroutines/flow/FlowKt__CollectKt$collectIndexed$2", "Lkotlinx/coroutines/flow/FlowCollector;", "value", "", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, m5570k = 1, m5571mv = {1, 8, 0}, m5573xi = CardPresenter.CARD_HEIGHT)
...
public final class FlowKt__CollectKt$collectIndexed$2 implements FlowCollector<Object> {
    ...
    /* renamed from: b */
    public final /* synthetic */ Function3 f21619b;
    ...
    public Object emit(Object obj, @NotNull Continuation<? super Unit> continuation) {
        ...
        this.f21618a = i + 1;
        if (i >= 0) {
            Object invoke = this.f21619b.invoke(Boxing.boxInt(i), obj, continuation);
    ...
    public Object emit$$forInline(Object obj, @NotNull final Continuation<? super Unit> continuation) {
        ...
        this.f21618a = i + 1;
        if (i >= 0) {
            this.f21619b.invoke(Integer.valueOf(i), obj, continuation);
            return Unit.INSTANCE;
        }
        throw new ArithmeticException("Index overflow has happened");
    }
