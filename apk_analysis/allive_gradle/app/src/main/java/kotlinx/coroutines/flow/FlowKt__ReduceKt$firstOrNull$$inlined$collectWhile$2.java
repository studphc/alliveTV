...
public final class FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2 implements FlowCollector<Object> {
    ...
    /* renamed from: a */
    public final /* synthetic */ Function2 f21747a;

    /* renamed from: b */
    public final /* synthetic */ Ref.ObjectRef f21748b;

    @Metadata(m5570k = 3, m5571mv = {1, 8, 0}, m5573xi = 48)
    @DebugMetadata(m5600c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2", m5601f = "Reduce.kt", m5602i = {0, 0}, m5603l = {142}, m5604m = "emit", m5605n = {"this", "it"}, m5606s = {"L$0", "L$1"})
    @SourceDebugExtension({"SMAP\nLimit.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Limit.kt\nkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$collector$1$emit$1\n*L\n1#1,141:1\n*E\n"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2$1 */
    /* loaded from: classes2.dex */
    public static final class C14471 extends ContinuationImpl {

        /* renamed from: d */
        public FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2 f21749d;
        ...
        /* renamed from: h */
        public Object f21753h;

        public C14471(Continuation continuation) {
            super(continuation);
        }
    ...
    public FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2(Function2 function2, Ref.ObjectRef objectRef) {
        this.f21747a = function2;
        this.f21748b = objectRef;
    }
    ...
    */
    public Object emit(Object obj, @NotNull Continuation<? super Unit> continuation) {
        ...
        T t;
        if (continuation instanceof C14471) {
            c14471 = (C14471) continuation;
            int i2 = c14471.f21751f;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                c14471.f21751f = i2 - Integer.MIN_VALUE;
                obj2 = c14471.f21750e;
                Object coroutine_suspended = b51.getCOROUTINE_SUSPENDED();
                i = c14471.f21751f;
                if (i == 0) {
                    if (i == 1) {
                        Object obj3 = c14471.f21753h;
                        flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2 = c14471.f21749d;
                    ...
                    c14471.f21751f = 1;
                    InlineMarker.mark(6);
                    obj2 = this.f21747a.invoke(obj, c14471);
                    InlineMarker.mark(7);
                ...
                flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2.f21748b.element = t;
                throw new AbortFlowException(flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2);
            }
        }
        c14471 = new C14471(continuation);
        obj2 = c14471.f21750e;
