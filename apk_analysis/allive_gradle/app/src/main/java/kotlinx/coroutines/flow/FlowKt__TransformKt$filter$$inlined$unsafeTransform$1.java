...
public final class FlowKt__TransformKt$filter$$inlined$unsafeTransform$1 implements Flow<Object> {
    ...
    /* renamed from: a */
    public final /* synthetic */ Flow f21761a;

    /* renamed from: b */
    public final /* synthetic */ Function2 f21762b;
    ...
    /* loaded from: classes2.dex */
    public static final class C14492<T> implements FlowCollector {

        /* renamed from: a */
        public final /* synthetic */ FlowCollector f21765a;

        /* renamed from: b */
        public final /* synthetic */ Function2 f21766b;

        @Metadata(m5570k = 3, m5571mv = {1, 8, 0}, m5573xi = CardPresenter.CARD_HEIGHT)
        @DebugMetadata(m5600c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filter$$inlined$unsafeTransform$1$2", m5601f = "Transform.kt", m5602i = {0, 0}, m5603l = {223, 223}, m5604m = "emit", m5605n = {"value", "$this$filter_u24lambda_u240"}, m5606s = {"L$0", "L$1"})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                return C14492.this.emit(null, this);
            }
        }

        public C14492(FlowCollector flowCollector, Function2 function2) {
            this.f21765a = flowCollector;
            this.f21766b = function2;
        }
        ...
        */
        public final Object emit(T t, @NotNull Continuation<? super Unit> continuation) {
            ...
            if (continuation instanceof AnonymousClass1) {
                ...
                int i2 = anonymousClass1.f21768e;
                if ((i2 & Integer.MIN_VALUE) != 0) {
                    anonymousClass1.f21768e = i2 - Integer.MIN_VALUE;
                    obj = anonymousClass1.f21767d;
                    Object coroutine_suspended = b51.getCOROUTINE_SUSPENDED();
                    i = anonymousClass1.f21768e;
                    if (i == 0) {
                        if (i != 1) {
                            if (i == 2) {
                        ...
                        FlowCollector flowCollector2 = anonymousClass1.f21771h;
                        obj2 = anonymousClass1.f21770g;
                        ResultKt.throwOnFailure(obj);
                        flowCollector = flowCollector2;
                    } else {
                        ResultKt.throwOnFailure(obj);
                        anonymousClass1.f21770g = t;
                        FlowCollector flowCollector3 = this.f21765a;
                        anonymousClass1.f21771h = flowCollector3;
                        anonymousClass1.f21768e = 1;
                        Object invoke = this.f21766b.invoke(t, anonymousClass1);
                    ...
                    if (((Boolean) obj).booleanValue()) {
                        anonymousClass1.f21770g = null;
                        anonymousClass1.f21771h = null;
                        anonymousClass1.f21768e = 2;
        ...
        public final Object emit$$forInline(Object obj, @NotNull Continuation continuation) {
            ...
            InlineMarker.mark(5);
            if (((Boolean) this.f21766b.invoke(obj, continuation)).booleanValue()) {
                InlineMarker.mark(0);
                this.f21765a.emit(obj, continuation);
                InlineMarker.mark(1);
            }
            return Unit.INSTANCE;
        }
    ...
    public FlowKt__TransformKt$filter$$inlined$unsafeTransform$1(Flow flow, Function2 function2) {
        this.f21761a = flow;
        this.f21762b = function2;
    }

    @Override // kotlinx.coroutines.flow.Flow
    @Nullable
    public Object collect(@NotNull FlowCollector<? super Object> flowCollector, @NotNull Continuation continuation) {
        Object collect = this.f21761a.collect(new C14492(flowCollector, this.f21762b), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$filter$$inlined$unsafeTransform$1.1
            ...
            /* renamed from: d */
            public /* synthetic */ Object f21763d;
        ...
        InlineMarker.mark(5);
        C14492 c14492 = new C14492(flowCollector, this.f21762b);
        InlineMarker.mark(0);
        this.f21761a.collect(c14492, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
