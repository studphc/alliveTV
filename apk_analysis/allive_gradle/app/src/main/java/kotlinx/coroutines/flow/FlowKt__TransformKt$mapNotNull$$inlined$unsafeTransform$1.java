...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1 implements Flow<Object> {
    ...
    /* renamed from: a */
    public final /* synthetic */ Flow f21812a;

    /* renamed from: b */
    public final /* synthetic */ Function2 f21813b;
    ...
    /* loaded from: classes2.dex */
    public static final class C14592<T> implements FlowCollector {

        /* renamed from: a */
        public final /* synthetic */ FlowCollector f21816a;

        /* renamed from: b */
        public final /* synthetic */ Function2 f21817b;

        @Metadata(m5570k = 3, m5571mv = {1, 8, 0}, m5573xi = CardPresenter.CARD_HEIGHT)
        @DebugMetadata(m5600c = "kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1$2", m5601f = "Transform.kt", m5602i = {0}, m5603l = {223, 224}, m5604m = "emit", m5605n = {"$this$mapNotNull_u24lambda_u246"}, m5606s = {"L$0"})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                this.f21818d = obj;
                this.f21819e |= Integer.MIN_VALUE;
                return C14592.this.emit(null, this);
            }
        }

        public C14592(FlowCollector flowCollector, Function2 function2) {
            this.f21816a = flowCollector;
            this.f21817b = function2;
        }
        ...
        */
        public final Object emit(T t, @NotNull Continuation<? super Unit> continuation) {
            ...
            if (continuation instanceof AnonymousClass1) {
                ...
                int i2 = anonymousClass1.f21819e;
                if ((i2 & Integer.MIN_VALUE) != 0) {
                    anonymousClass1.f21819e = i2 - Integer.MIN_VALUE;
                    obj = anonymousClass1.f21818d;
                    Object coroutine_suspended = b51.getCOROUTINE_SUSPENDED();
                    i = anonymousClass1.f21819e;
                    if (i == 0) {
                        if (i != 1) {
                            if (i == 2) {
                        ...
                        FlowCollector flowCollector2 = anonymousClass1.f21821g;
                        ResultKt.throwOnFailure(obj);
                        flowCollector = flowCollector2;
                    } else {
                        ResultKt.throwOnFailure(obj);
                        FlowCollector flowCollector3 = this.f21816a;
                        anonymousClass1.f21821g = flowCollector3;
                        anonymousClass1.f21819e = 1;
                        Object invoke = this.f21817b.invoke(t, anonymousClass1);
                    ...
                    if (obj != null) {
                        anonymousClass1.f21821g = null;
                        anonymousClass1.f21819e = 2;
        ...
        public final Object emit$$forInline(Object obj, @NotNull Continuation continuation) {
            ...
            InlineMarker.mark(5);
            Object invoke = this.f21817b.invoke(obj, continuation);
            if (invoke != null) {
                InlineMarker.mark(0);
                this.f21816a.emit(invoke, continuation);
                InlineMarker.mark(1);
            }
            return Unit.INSTANCE;
        }
    ...
    public FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1(Flow flow, Function2 function2) {
        this.f21812a = flow;
        this.f21813b = function2;
    }

    @Override // kotlinx.coroutines.flow.Flow
    @Nullable
    public Object collect(@NotNull FlowCollector<? super Object> flowCollector, @NotNull Continuation continuation) {
        Object collect = this.f21812a.collect(new C14592(flowCollector, this.f21813b), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1.1
            ...
            /* renamed from: d */
            public /* synthetic */ Object f21814d;
        ...
        InlineMarker.mark(5);
        C14592 c14592 = new C14592(flowCollector, this.f21813b);
        InlineMarker.mark(0);
        this.f21812a.collect(c14592, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
