...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$3 implements Flow<Object> {
    ...
    /* renamed from: a */
    public final /* synthetic */ Flow[] f21868a;

    /* renamed from: b */
    public final /* synthetic */ Function2 f21869b;

    public FlowKt__ZipKt$combine$$inlined$unsafeFlow$3(Flow[] flowArr, Function2 function2) {
        this.f21868a = flowArr;
        this.f21869b = function2;
    }
    ...
    public Object collect(@NotNull FlowCollector<? super Object> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        ...
        Flow[] flowArr = this.f21868a;
        FlowKt__ZipKt$combine$6$1 flowKt__ZipKt$combine$6$1 = new FlowKt__ZipKt$combine$6$1(flowArr);
        Intrinsics.needClassReification();
        Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, flowKt__ZipKt$combine$6$1, new FlowKt__ZipKt$combine$6$2(this.f21869b, null), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        FlowKt__ZipKt$combine$6$1 flowKt__ZipKt$combine$6$1 = new FlowKt__ZipKt$combine$6$1(flowArr);
        Intrinsics.needClassReification();
        FlowKt__ZipKt$combine$6$2 flowKt__ZipKt$combine$6$2 = new FlowKt__ZipKt$combine$6$2(this.f21869b, null);
        InlineMarker.mark(0);
