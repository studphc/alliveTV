...
public abstract class Segment<S extends Segment<S>> extends ConcurrentLinkedListNode<S> implements NotCompleted {
    ...
    /* renamed from: c */
    public static final AtomicIntegerFieldUpdater f22038c = AtomicIntegerFieldUpdater.newUpdater(Segment.class, "cleanedAndPointers");
    ...
    public final boolean decPointers$kotlinx_coroutines_core() {
        if (f22038c.addAndGet(this, SupportMenu.CATEGORY_MASK) == getNumberOfSlots() && !isTail()) {
            return true;
        }
        return false;
    }
    ...
    public boolean isRemoved() {
        if (f22038c.get(this) == getNumberOfSlots() && !isTail()) {
            return true;
        }
        return false;
    }
    ...
    public final void onSlotCleaned() {
        if (f22038c.incrementAndGet(this) == getNumberOfSlots()) {
            remove();
        }
    }
    ...
    public final boolean tryIncPointers$kotlinx_coroutines_core() {
        ...
        int i;
        do {
            atomicIntegerFieldUpdater = f22038c;
