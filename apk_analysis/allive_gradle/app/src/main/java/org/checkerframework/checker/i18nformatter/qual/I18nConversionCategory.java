...
public enum I18nConversionCategory {
    ...
    /* renamed from: a */
    public static final I18nConversionCategory[] f24884a = {DATE, NUMBER};
    ...
    public static I18nConversionCategory stringToI18nConversionCategory(String str) {
        ...
        I18nConversionCategory[] i18nConversionCategoryArr = f24884a;
        for (int i = 0; i < 2; i++) {
        ...
        throw new IllegalArgumentException(AbstractC1726qj.m7038C("Invalid format type ", lowerCase));
    }
    ...
    public String toString() {
        ...
        if (this.types == null) {
            ...
            StringJoiner m4863p = fx0.m4863p();
            for (Class<?> cls : this.types) {
                m4863p.add(cls.getCanonicalName());
            }
            sb.append(m4863p);
        }
        return sb.toString();
