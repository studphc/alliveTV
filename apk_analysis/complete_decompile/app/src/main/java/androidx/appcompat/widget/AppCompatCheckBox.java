...
public class AppCompatCheckBox extends CheckBox implements TintableCompoundButton, TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    /* renamed from: a */
    public final C1576n8 f1125a;

    /* renamed from: b */
    public final C1345j8 f1126b;

    /* renamed from: c */
    public final C1151ea f1127c;

    /* renamed from: d */
    public C1503l9 f1128d;
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion {
        ...
        public void mapProperties(@NonNull PropertyMapper propertyMapper) {
            ...
            this.f1130b = mapObject;
            mapObject2 = propertyMapper.mapObject("backgroundTintMode", R.attr.backgroundTintMode);
            this.f1131c = mapObject2;
            mapObject3 = propertyMapper.mapObject("buttonTint", R.attr.buttonTint);
            this.f1132d = mapObject3;
            mapObject4 = propertyMapper.mapObject("buttonTintMode", R.attr.buttonTintMode);
            this.f1133e = mapObject4;
            mapObject5 = propertyMapper.mapObject("drawableTint", R.attr.drawableTint);
            this.f1134f = mapObject5;
            mapObject6 = propertyMapper.mapObject("drawableTintMode", R.attr.drawableTintMode);
            this.f1135g = mapObject6;
            this.f1129a = true;
        }

        public void readProperties(@NonNull AppCompatCheckBox appCompatCheckBox, @NonNull PropertyReader propertyReader) {
            if (this.f1129a) {
                propertyReader.readObject(this.f1130b, appCompatCheckBox.getBackgroundTintList());
                propertyReader.readObject(this.f1131c, appCompatCheckBox.getBackgroundTintMode());
                propertyReader.readObject(this.f1132d, appCompatCheckBox.getButtonTintList());
                propertyReader.readObject(this.f1133e, appCompatCheckBox.getButtonTintMode());
                propertyReader.readObject(this.f1134f, appCompatCheckBox.getCompoundDrawableTintList());
                propertyReader.readObject(this.f1135g, appCompatCheckBox.getCompoundDrawableTintMode());
                return;
            }
    ...
    public void drawableStateChanged() {
        ...
        C1345j8 c1345j8 = this.f1126b;
        if (c1345j8 != null) {
            c1345j8.m5407a();
        }
        C1151ea c1151ea = this.f1127c;
        if (c1151ea != null) {
            c1151ea.m4672b();
        }
    }
