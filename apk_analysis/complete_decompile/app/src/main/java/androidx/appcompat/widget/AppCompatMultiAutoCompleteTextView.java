...
public class AppCompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView implements TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    /* renamed from: d */
    public static final int[] f1180d = {R.attr.popupBackground};

    /* renamed from: a */
    public final C1345j8 f1181a;

    /* renamed from: b */
    public final C1151ea f1182b;

    /* renamed from: c */
    public final C1383k9 f1183c;
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion {
        ...
        public void readProperties(@NonNull AppCompatMultiAutoCompleteTextView appCompatMultiAutoCompleteTextView, @NonNull PropertyReader propertyReader) {
            if (this.f1184a) {
                propertyReader.readObject(this.f1185b, appCompatMultiAutoCompleteTextView.getBackgroundTintList());
                propertyReader.readObject(this.f1186c, appCompatMultiAutoCompleteTextView.getBackgroundTintMode());
                propertyReader.readObject(this.f1187d, appCompatMultiAutoCompleteTextView.getCompoundDrawableTintList());
                propertyReader.readObject(this.f1188e, appCompatMultiAutoCompleteTextView.getCompoundDrawableTintMode());
                return;
            }
    ...
    public void drawableStateChanged() {
        ...
        C1345j8 c1345j8 = this.f1181a;
        if (c1345j8 != null) {
            c1345j8.m5407a();
        }
        C1151ea c1151ea = this.f1182b;
        if (c1151ea != null) {
            c1151ea.m4672b();
        }
    }
    ...
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1182b.m4674e();
    }

    @Override // androidx.appcompat.widget.EmojiCompatConfigurationView
    public boolean isEmojiCompatEnabled() {
        return this.f1183c.f20791b.isEnabled();
    }
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f1183c.f20791b.onCreateInputConnection(onCreateInputConnection, editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z) {
        this.f1183c.f20791b.setEnabled(z);
    }

    @Override // android.widget.TextView
    public void setKeyListener(@Nullable KeyListener keyListener) {
        super.setKeyListener(this.f1183c.m5512a(keyListener));
    }
    ...
    public AppCompatMultiAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, f1180d, i, 0);
