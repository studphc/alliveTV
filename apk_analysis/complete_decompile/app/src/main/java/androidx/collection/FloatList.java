...
public abstract class FloatList {
    ...
    public FloatList(int i, DefaultConstructorMarker defaultConstructorMarker) {
        float[] fArr;
        if (i == 0) {
