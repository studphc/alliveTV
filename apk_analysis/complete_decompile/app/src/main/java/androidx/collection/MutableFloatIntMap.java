...
public final class MutableFloatIntMap extends FloatIntMap {
    ...
    /* renamed from: b */
    public final int m335b(float f) {
        int i;
        ...
        while (true) {
            ...
            if ((((~j) << 6) & j & (-9187201950435737472L)) != 0) {
                ...
                if (this.f1706a == 0) {
                    long j5 = 254;
                    if (((this.metadata[m334a >> 3] >> ((m334a & 7) << 3)) & 255) != 254) {
                        if (this._capacity > 8) {
                        ...
                        m337d(ScatterMapKt.nextCapacity(this._capacity));
                        m334a = m334a(i3);
                    }
                }
                this._size++;
    ...
    public final void m336c(int i) {
        ...
        long j = 255 << ((i2 & 7) << 3);
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f1706a = ScatterMapKt.loadedCapacity(get_capacity()) - this._size;
    ...
    public MutableFloatIntMap(int i) {
        super(null);
        if (i >= 0) {
            m336c(ScatterMapKt.unloadedCapacity(i));
            return;
        }
