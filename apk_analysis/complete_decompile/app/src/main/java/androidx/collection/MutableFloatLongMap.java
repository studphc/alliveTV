...
public final class MutableFloatLongMap extends FloatLongMap {
    ...
    /* renamed from: b */
    public final int m339b(float f) {
        int i;
        ...
        while (true) {
            ...
            if ((((~j) << 6) & j & (-9187201950435737472L)) != 0) {
                ...
                if (this.f1707a == 0) {
                    long j5 = 254;
                    if (((this.metadata[m338a >> 3] >> ((m338a & 7) << 3)) & 255) != 254) {
                        if (this._capacity > 8) {
                        ...
                        m341d(ScatterMapKt.nextCapacity(this._capacity));
                        m338a = m338a(i3);
                    }
                }
                this._size++;
    ...
    public final void m340c(int i) {
        ...
        long j = 255 << ((i2 & 7) << 3);
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f1707a = ScatterMapKt.loadedCapacity(get_capacity()) - this._size;
    ...
    public final void m341d(int i) {
        ...
        while (i3 < i2) {
            if (((jArr2[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                ...
                int i8 = ((m338a - 7) & i7) + (i7 & 7);
                int i9 = i8 >> 3;
                int i10 = (i8 & 7) << 3;
                jArr5[i9] = ((~(255 << i10)) & jArr5[i9]) | (j << i10);
                fArr3[m338a] = f;
                jArr4[m338a] = jArr3[i3];
            } else {
                jArr = jArr2;
                fArr = fArr2;
            }
    ...
    public MutableFloatLongMap(int i) {
        super(null);
        if (i >= 0) {
            m340c(ScatterMapKt.unloadedCapacity(i));
            return;
        }
