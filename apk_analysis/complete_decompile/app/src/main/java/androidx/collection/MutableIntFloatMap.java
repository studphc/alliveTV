...
public final class MutableIntFloatMap extends IntFloatMap {
    ...
    public final int m352b(int i) {
        ...
        while (true) {
            ...
            if ((((~j) << 6) & j & (-9187201950435737472L)) != 0) {
                int m351a = m351a(i4);
                long j5 = 128;
                if (this.f1710a == 0 && ((this.metadata[m351a >> 3] >> ((m351a & 7) << 3)) & 255) != 254) {
                    if (this._capacity > 8) {
                    ...
                    m354d(ScatterMapKt.nextCapacity(this._capacity));
                    m351a = m351a(i4);
                }
                int i21 = 1;
                this._size++;
    ...
    public final void m353c(int i) {
        ...
        long j = 255 << ((i2 & 7) << 3);
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f1710a = ScatterMapKt.loadedCapacity(get_capacity()) - this._size;
    ...
    public MutableIntFloatMap(int i) {
        super(null);
        if (i >= 0) {
            m353c(ScatterMapKt.unloadedCapacity(i));
            return;
        }
