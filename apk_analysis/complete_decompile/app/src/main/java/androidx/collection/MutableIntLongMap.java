...
public final class MutableIntLongMap extends IntLongMap {
    ...
    public final int m360b(int i) {
        ...
        while (true) {
            ...
            if ((((~j) << 6) & j & (-9187201950435737472L)) != 0) {
                int m359a = m359a(i4);
                long j5 = 128;
                if (this.f1712a == 0 && ((this.metadata[m359a >> 3] >> ((m359a & 7) << 3)) & 255) != 254) {
                    if (this._capacity > 8) {
                    ...
                    m362d(ScatterMapKt.nextCapacity(this._capacity));
                    m359a = m359a(i4);
                }
                int i21 = 1;
                this._size++;
    ...
    public final void m361c(int i) {
        ...
        long j = 255 << ((i2 & 7) << 3);
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f1712a = ScatterMapKt.loadedCapacity(get_capacity()) - this._size;
    ...
    public final void m362d(int i) {
        ...
        while (i3 < i2) {
            if (((jArr2[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                ...
                int i10 = ((m359a - 7) & i9) + (i9 & 7);
                int i11 = i10 >> 3;
                int i12 = (i10 & 7) << 3;
                jArr5[i11] = ((~(255 << i12)) & jArr5[i11]) | (j << i12);
                iArr3[m359a] = i4;
                jArr4[m359a] = jArr3[i3];
            } else {
                jArr = jArr2;
                iArr = iArr2;
            }
    ...
    public MutableIntLongMap(int i) {
        super(null);
        if (i >= 0) {
            m361c(ScatterMapKt.unloadedCapacity(i));
            return;
        }
