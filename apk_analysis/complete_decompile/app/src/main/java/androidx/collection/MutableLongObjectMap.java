...
public final class MutableLongObjectMap<V> extends LongObjectMap<V> {
    ...
    public final int m384a(long j) {
        ...
        while (true) {
            ...
            if ((((~j2) << 6) & j2 & (-9187201950435737472L)) != 0) {
                ...
                if (this.f1718a == 0) {
                    long j6 = 254;
                    if (((this.metadata[m385b >> 3] >> ((m385b & 7) << 3)) & 255) != 254) {
                        if (this._capacity > 8) {
                        ...
                        m387d(ScatterMapKt.nextCapacity(this._capacity));
                        m385b = m385b(i4);
                    }
                }
                this._size++;
    ...
    public final void m386c(int i) {
        ...
        long j = 255 << ((i2 & 7) << 3);
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f1718a = ScatterMapKt.loadedCapacity(get_capacity()) - this._size;
    ...
    public final void m387d(int i) {
        ...
        while (i3 < i2) {
            if (((jArr3[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                ...
                int i9 = ((m385b - 7) & i8) + (i8 & 7);
                int i10 = i9 >> 3;
                int i11 = (i9 & 7) << 3;
                jArr6[i10] = (jArr6[i10] & (~(255 << i11))) | (j2 << i11);
                jArr5[m385b] = j;
                objArr2[m385b] = objArr[i3];
            } else {
                jArr = jArr3;
                jArr2 = jArr4;
            }
    ...
    */
    ...
    public MutableLongObjectMap(int i) {
        super(null);
        if (i >= 0) {
            m386c(ScatterMapKt.unloadedCapacity(i));
            return;
        }
