...
public final class MutableLongSet extends LongSet {
    ...
    public final int m388a(long j) {
        ...
        while (true) {
            ...
            if ((((~j2) << 6) & j2 & (-9187201950435737472L)) != 0) {
                ...
                if (this.f1719a == 0) {
                    long j6 = 254;
                    if (((this.metadata[m389b >> 3] >> ((m389b & 7) << 3)) & 255) != 254) {
                        if (this._capacity > 8) {
                        ...
                        m392e(ScatterMapKt.nextCapacity(this._capacity));
                        m389b = m389b(i4);
                    }
                }
                this._size++;
    ...
    public final boolean add(long element) {
        int i = this._size;
        this.elements[m388a(element)] = element;
        if (this._size != i) {
            return true;
        }
        return false;
    ...
    public final void m390c(int i) {
        ...
        long j = 255 << ((i2 & 7) << 3);
        jArr[i3] = (jArr[i3] & (~j)) | j;
        this.f1719a = ScatterMapKt.loadedCapacity(get_capacity()) - this._size;
    ...
    */
    ...
    public MutableLongSet(int i) {
        super(null);
        if (i >= 0) {
            m390c(ScatterMapKt.unloadedCapacity(i));
            return;
        }
