...
public final class MutableScatterMap$MutableMapWrapper$keys$1 implements Set<Object>, KMutableSet {
    ...
    /* renamed from: a */
    public final /* synthetic */ MutableScatterMap f1729a;

    public MutableScatterMap$MutableMapWrapper$keys$1(MutableScatterMap mutableScatterMap) {
        this.f1729a = mutableScatterMap;
    }
    ...
    public boolean contains(Object element) {
        return this.f1729a.containsKey(element);
    }
    ...
    public boolean containsAll(@NotNull Collection<? extends Object> elements) {
        ...
        while (it.hasNext()) {
            if (!this.f1729a.containsKey(it.next())) {
                return false;
            }
        }
        return true;
    ...
    public Iterator<Object> iterator() {
        return new MutableScatterMap$MutableMapWrapper$keys$1$iterator$1(this.f1729a);
    }
    ...
    */
    public boolean remove(Object element) {
        ...
        int i4 = i3 ^ (i3 << 16);
        int i5 = i4 & 127;
        MutableScatterMap mutableScatterMap = this.f1729a;
        int i6 = mutableScatterMap._capacity;
        int i7 = (i4 >>> 7) & i6;
        int i8 = 0;
        loop0: while (true) {
            ...
            while (true) {
                ...
                if (Intrinsics.areEqual(mutableScatterMap.keys[i2], element)) {
                    break loop0;
                }
                j3 &= j3 - 1;
            }
        ...
        if (i2 >= 0) {
            mutableScatterMap.removeValueAt(i2);
            return true;
        }
        return false;
    }
