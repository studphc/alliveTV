                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i10 < i9) {
                            if ((j & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                m7063s.append((CharSequence) function2.invoke(obj2, Integer.valueOf(i12)));
                                i6++;
                                i3 = 8;
                            } else {
                                jArr2 = jArr3;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((j & 255) < 128) {
                            ...
                            m7063s.append(transform.invoke(obj, Integer.valueOf(i7)));
                            i2++;
                        } else {
                            objArr2 = objArr3;
                        }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i7 < i6) {
                        if ((j & 255) < 128) {
                            ...
                            m7063s.append(function2.invoke(obj, Integer.valueOf(i9)));
                            i4++;
                            i2 = 8;
                        } else {
                            i2 = i5;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i6 < i5) {
                        if ((j & 255) < 128) {
                            ...
                            m7063s.append(function2.invoke(obj, Integer.valueOf(i8)));
                            i3++;
                            i = 8;
                        } else {
                            i = i4;
