...
public class SparseArrayCompat<E> implements Cloneable {
    ...
    public void put(int key, E value) {
        ...
        int i = ~binarySearch;
        if (i < this.size && this.values[i] == SparseArrayCompatKt.f1756a) {
            this.keys[i] = key;
            this.values[i] = value;
            return;
        }
    ...
    public void putAll(@NotNull SparseArrayCompat<? extends E> other) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (binarySearch >= 0) {
                ...
                int i2 = ~binarySearch;
                if (i2 < this.size && this.values[i2] == SparseArrayCompatKt.f1756a) {
                    this.keys[i2] = keyAt;
    ...
    public void removeAt(int index) {
        if (this.values[index] != SparseArrayCompatKt.f1756a) {
            this.values[index] = SparseArrayCompatKt.f1756a;
            this.garbage = true;
        }
    }
    ...
    public SparseArrayCompat<E> m8472clone() {
