...
public class Utils {
    ...
    /* renamed from: a */
    public static DebugHandle f2269a;
    ...
    public static int rgbaTocColor(float f, float f2, float f3, float f4) {
        int m447a = m447a((int) (f * 255.0f));
        int m447a2 = m447a((int) (f2 * 255.0f));
        return (m447a << 16) | (m447a((int) (f4 * 255.0f)) << 24) | (m447a2 << 8) | m447a((int) (f3 * 255.0f));
    }
    ...
    public int getInterpolatedColor(float[] fArr) {
        return (m447a((int) (fArr[3] * 255.0f)) << 24) | (m447a((int) (((float) Math.pow(fArr[0], 0.45454545454545453d)) * 255.0f)) << 16) | (m447a((int) (((float) Math.pow(fArr[1], 0.45454545454545453d)) * 255.0f)) << 8) | m447a((int) (((float) Math.pow(fArr[2], 0.45454545454545453d)) * 255.0f));
    }
    ...
    public static void log(String str) {
        ...
        DebugHandle debugHandle = f2269a;
        if (debugHandle != null) {
