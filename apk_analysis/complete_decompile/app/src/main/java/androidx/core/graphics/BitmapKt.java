...
public final class BitmapKt {
    ...
    public static final boolean contains(@NotNull Bitmap bitmap, @NotNull PointF pointF) {
        float f = pointF.x;
        if (f >= RecyclerView.f7068F0 && f < bitmap.getWidth()) {
            float f2 = pointF.y;
            if (f2 >= RecyclerView.f7068F0 && f2 < bitmap.getHeight()) {
                return true;
            }
        }
        return false;
