...
public final class Preconditions {
    ...
    public static float checkArgumentFinite(float f, @NonNull String str) {
        if (!Float.isNaN(f)) {
            ...
            throw new IllegalArgumentException(AbstractC1726qj.m7057m(str, " must not be infinite"));
        }
        throw new IllegalArgumentException(AbstractC1726qj.m7057m(str, " must not be NaN"));
    }
    ...
    public static long checkArgumentInRange(long j, long j2, long j3, @NonNull String str) {
        if (j < j2) {
            ...
            sb.append(j2);
            sb.append(", ");
            throw new IllegalArgumentException(ye0.m8297q(sb, j3, "] (too low)"));
        }
        if (j <= j3) {
            return j;
        }
        ...
        sb2.append(j2);
        sb2.append(", ");
        throw new IllegalArgumentException(ye0.m8297q(sb2, j3, "] (too high)"));
    }
