...
public final class C0213b extends InputConnectionWrapper {

    /* renamed from: a */
    public final /* synthetic */ InputConnectionCompat.OnCommitContentListener f3993a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0213b(InputConnection inputConnection, InputConnectionCompat.OnCommitContentListener onCommitContentListener) {
        super(inputConnection, false);
        this.f3993a = onCommitContentListener;
    }
    ...
    public final boolean performPrivateCommand(String str, Bundle bundle) {
        ...
        String str6;
        String str7;
        InputConnectionCompat.OnCommitContentListener onCommitContentListener = this.f3993a;
        boolean z = false;
        z = false;
        z = false;
        z = false;
