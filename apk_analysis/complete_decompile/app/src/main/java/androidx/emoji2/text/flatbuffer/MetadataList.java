...
public final class MetadataList extends Table {
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataList get(MetadataList metadataList, int i) {
            return metadataList.__assign(Table.__indirect(__element(i), this.f4244bb), this.f4244bb);
        }
    }
    ...
    public MetadataItem list(MetadataItem metadataItem, int i) {
        ...
        return metadataItem.__assign(__indirect((i * 4) + __vector(__offset)), this.f4285bb);
    }

    public MetadataItem.Vector listVector(MetadataItem.Vector vector) {
        int __offset = __offset(6);
        if (__offset != 0) {
            return vector.__assign(__vector(__offset), 4, this.f4285bb);
        }
        return null;
    }
}
