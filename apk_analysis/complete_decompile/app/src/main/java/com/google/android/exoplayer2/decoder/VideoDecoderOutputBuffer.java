...
public class VideoDecoderOutputBuffer extends DecoderOutputBuffer {
    ...
    /* renamed from: b */
    public final DecoderOutputBuffer.Owner f9937b;
    ...
    /* renamed from: a */
    public static boolean m2509a(int i, int i2) {
    ...
    public boolean initForYuvFrame(int i, int i2, int i3, int i4, int i5) {
        ...
        this.colorspace = i5;
        int i6 = (int) ((i2 + 1) / 2);
        if (m2509a(i3, i2) && m2509a(i4, i6)) {
            int i7 = i2 * i3;
            int i8 = i6 * i4;
            int i9 = (i8 * 2) + i7;
            if (m2509a(i8, 2) && i9 >= i7) {
    ...
    public void release() {
        this.f9937b.releaseOutputBuffer(this);
    }
}
