...
public final class InternalFrame extends Id3Frame {
    public static final Parcelable.Creator<InternalFrame> CREATOR = new C1749r5(17);

    /* renamed from: ID */
    public static final String f10764ID = "----";
    ...
    public String toString() {
        return this.f10763id + ": domain=" + this.domain + ", description=" + this.description;
    }
