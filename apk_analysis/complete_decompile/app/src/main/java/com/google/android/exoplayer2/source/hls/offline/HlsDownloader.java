...
public final class HlsDownloader extends SegmentDownloader<HlsPlaylist> {
    ...
    /* renamed from: e */
    public static void m2796e(HlsMediaPlaylist hlsMediaPlaylist, HlsMediaPlaylist.Segment segment, HashSet hashSet, ArrayList arrayList) {
    ...
    public List<SegmentDownloader.Segment> getSegments(DataSource dataSource, HlsPlaylist hlsPlaylist, boolean z) {
            ...
            try {
                ...
                for (int i2 = 0; i2 < list2.size(); i2++) {
                    ...
                    if (segment3 != null && segment3 != segment) {
                        m2796e(hlsMediaPlaylist, segment3, hashSet, arrayList2);
                        segment = segment3;
                    }
                    m2796e(hlsMediaPlaylist, segment2, hashSet, arrayList2);
                }
            } catch (IOException e) {
                if (!z) {
                    throw e;
