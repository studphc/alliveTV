            ...
            if (pendingIntent != null) {
                try {
                    ...
                    if (extras.getBoolean("notify_manager", true)) {
                        ...
                        String m8296p = ye0.m8296p("Activity not found while launching ", pendingIntent.toString(), ".");
                        if (Build.FINGERPRINT.contains("generic")) {
                            m8296p = m8296p.concat(" This may occur when resolving Google Play services connection issues on emulators with Google APIs but not Google Play Store.");
                        }
                        Log.e("GoogleApiActivity", m8296p, e);
                    }
                    this.zaa = 1;
                    finish();
                    return;
