...
public final class zae extends zai {
    ...
    public final void zae(@NonNull Exception exc) {
        try {
            this.zaa.setFailedResult(new Status(10, AbstractC1726qj.m7058n(exc.getClass().getSimpleName(), ": ", exc.getLocalizedMessage())));
        } catch (IllegalStateException e) {
            Log.w("ApiCallRunner", "Exception reporting failure", e);
        }
    }
    ...
    public final void zag(@NonNull zaad zaadVar, boolean z) {
        ...
        zaadVar.f13188a.put(apiMethodImpl, Boolean.valueOf(z));
        apiMethodImpl.addStatusListener(new y63(zaadVar, apiMethodImpl));
    }
}
