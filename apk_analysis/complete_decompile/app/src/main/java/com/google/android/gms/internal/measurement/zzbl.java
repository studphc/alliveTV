...
public enum zzbl {
    ...
    /* renamed from: b */
    public static final HashMap f13789b = new HashMap();
    ...
    static {
        for (zzbl zzblVar : values()) {
            f13789b.put(Integer.valueOf(zzblVar.f13791a), zzblVar);
        }
    }
    ...
    public static zzbl zza(int i) {
        return (zzbl) f13789b.get(Integer.valueOf(i));
    }

    @Override // java.lang.Enum
    public final String toString() {
        return Integer.valueOf(this.f13791a).toString();
    }
