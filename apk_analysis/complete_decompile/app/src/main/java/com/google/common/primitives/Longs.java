...
public final class Longs {
    ...
    /* renamed from: a */
    public static int m4274a(long[] jArr, long j, int i, int i2) {
        while (i < i2) {
            if (jArr[i] == j) {
                return i;
            }
    ...
    public static List<Long> asList(long... jArr) {
        ...
        return new ge1(jArr, 0, jArr.length);
    }
    ...
    public static int indexOf(long[] jArr, long j) {
        return m4274a(jArr, j, 0, jArr.length);
    }
    ...
    public static long[] toArray(Collection<? extends Number> collection) {
        if (collection instanceof ge1) {
            ...
            return Arrays.copyOfRange(ge1Var.f17661a, ge1Var.f17662b, ge1Var.f17663c);
        }
    ...
    */
    ...
    public static Long tryParse(String str, int i) {
        ...
        if (i >= 2 && i <= 36) {
            ...
            char c = 128;
            if (charAt < 128) {
                b = ee1.f16782a[charAt];
            } else {
                byte[] bArr = ee1.f16782a;
                b = -1;
            }
            if (b < 0 || b >= i) {
                return null;
            ...
            while (i3 < str.length()) {
                ...
                if (charAt2 < c) {
                    b2 = ee1.f16782a[charAt2];
                } else {
                    byte[] bArr2 = ee1.f16782a;
                    b2 = -1;
                }
                if (b2 < 0 || b2 >= i || j < j3) {
                    return null;
        ...
        throw new IllegalArgumentException(ye0.m8290j(65, i, "radix must be between MIN_RADIX and MAX_RADIX but was "));
    }
