    ...
    public static final FirebaseAnalytics getAnalytics(@NonNull Firebase firebase) {
        ...
        if (f15480a == null) {
            synchronized (f15481b) {
                if (f15480a == null) {
                    f15480a = FirebaseAnalytics.getInstance(FirebaseKt.getApp(Firebase.INSTANCE).getApplicationContext());
                }
            }
        }
        FirebaseAnalytics firebaseAnalytics = f15480a;
