...
/* renamed from: com.hisona.allive.d0 */
/* loaded from: classes2.dex */
public final class C1071d0 extends BackgroundTask {

    /* renamed from: a */
    public final String f15983a;

    public C1071d0(Activity activity, String str) {
        super(activity);
        this.f15983a = str;
    }
    ...
    public final void doInBackground(ObservableEmitter observableEmitter) {
        try {
            String body = HttpRequest.get((CharSequence) this.f15983a, true, new Object[0]).trustAllHosts().trustAllCerts().connectTimeout(10000).userAgent(VersionChecker.getStringById(this.mWeakReference.get(), R.string.USERAGENT)).body();
            ...
            if (body != null && body.length() != 0) {
                ...
                if (jsonElement != null && !jsonElement.isJsonNull()) {
                    VersionChecker.f15961e = jsonElement.getAsString();
                }
                JsonElement jsonElement2 = asJsonObject.get("VersionInfo");
                if (jsonElement2 != null && !jsonElement2.isJsonNull()) {
                    VersionChecker.f15962f = jsonElement2.getAsString();
                }
    ...
    public final void onPostExecute(BackgroundTask.ProgressOrResult progressOrResult) {
        ...
        if (activity != null && !activity.isFinishing() && (str = VersionChecker.f15961e) != null && str.length() > 0 && Double.parseDouble(VersionChecker.f15960d) < Double.parseDouble(VersionChecker.f15961e)) {
            AlertDialog.Builder builder = new AlertDialog.Builder(activity);
            VersionChecker.f15959c = new C1069c0(activity, VersionChecker.f15961e);
            builder.setTitle(activity.getResources().getString(R.string.update_title_str));
            builder.setMessage(String.format(activity.getResources().getString(R.string.update_version_str), VersionChecker.f15961e) + "\n\n" + VersionChecker.f15962f);
                ...
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    switch (i2) {
                        case 0:
                            ...
                            try {
                                VersionChecker.f15959c.execute();
                                return;
                            } catch (Exception e) {
