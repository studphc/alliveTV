...
/* renamed from: com.hisona.allive.u */
/* loaded from: classes2.dex */
public final class C1087u extends BackgroundTask {
    ...
    /* renamed from: a */
    public final String m4479a(ChannelData channelData) {
        int siteType = channelData.getSiteType();
        int qualityType = channelData.getQualityType();
        if (siteType == Utils.SiteType.Wavve.ordinal()) {
            int i = AbstractC1086t.f16006b[SettingsData.WavveQualityType.values()[qualityType].ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i != 4) {
        ...
        if (siteType == Utils.SiteType.Tving.ordinal()) {
            int i2 = AbstractC1086t.f16007c[SettingsData.TvingQualityType.values()[qualityType].ordinal()];
            if (i2 != 1) {
                if (i2 != 2) {
                    if (i2 != 3) {
                        if (i2 != 4) {
    ...
    public final void doInBackground(ObservableEmitter observableEmitter) {
        ...
        int ordinal2;
        ArrayList arrayList = PlayerActivity.f15870e0;
        int i = this.f16014g;
        if (i < 0) {
        ...
        if (channelData.getSiteType() == Utils.SiteType.Wavve.ordinal()) {
            String str4 = (String) PlayerActivity.f15871f0.get(0);
            this.f16008a = str4;
            if (str4 != null && str4.length() >= 10) {
                try {
                    HttpRequest header = HttpRequest.get((CharSequence) "https://delivery.wavve.com/v1/streaming/live", true, "device", "pc", "partner", "pooq", "apikey", "E5F3E0D30947AA5440556471321BB6D9", NotificationCompat.CATEGORY_SERVICE, "wavve", "pooqzone", SchedulerSupport.NONE, "region", "kor", "drm", "wm", "targetage", "all", "contentid", channelData.getId(), "audioChannel", "2ch", "hdr", "sdr", "videocodec", "avc", "audiocodec", "aac", "issurround", "n", "format", "normal", "withinsubtitle", "n", "contenttype", "live", "action", "hls", "protocol", "hls", "quality", m4479a(channelData), "deviceModelId", "mobile", "guid", PlayerActivity.f15872g0, "lastplayid", PlayerActivity.f15873h0, "authtype", "cookie", "isabr", "y", "ishevc", "n").trustAllHosts().trustAllCerts().connectTimeout(5000).userAgent(getString(R.string.USERAGENT)).header("wavve-credential", this.f16008a);
                    if (header != null && !header.badRequest() && !header.isBodyEmpty()) {
                        ...
                        this.f16009b = asString;
                        if (asString != null && !asString.equals("null") && this.f16009b.length() != 0) {
                            this.f16010c = asJsonObject.get("awscookie").getAsString();
                            if (!this.f16009b.contains("AVC-FHD") && !this.f16009b.contains("live5000")) {
                                if (!this.f16009b.contains("AVC-HD") && !this.f16009b.contains("live2000")) {
                                    if (!this.f16009b.contains("AVC-SD") && !this.f16009b.contains("live1000")) {
                                        channelData.setResolution("MD");
                                        PlayerActivity.f15873h0 = asJsonObject.get("playid").getAsString();
        ...
        if (channelData.getSiteType() == Utils.SiteType.Tving.ordinal()) {
            String str5 = (String) PlayerActivity.f15871f0.get(1);
            this.f16008a = str5;
            if (str5 != null && str5.length() >= 10) {
                try {
                    String l = Long.toString(System.currentTimeMillis() / 1000);
                    String id = channelData.getId();
                    HttpRequest header2 = HttpRequest.get((CharSequence) "https://api.tving.com/v2/media/stream/info", true, "apiKey", "1e7952d0917d6aab1f0293a063697610", "info", "Y", "networkCode", "CSND0900", "osCode", "CSOD0900", "teleCode", "CSCD0900", "mediaCode", id, "screenCode", "CSSD0100", "streamCode", m4479a(channelData), "noCache", l, "callingFrom", "HTML5", "adReq", SchedulerSupport.NONE, "ooc", "").trustAllHosts().trustAllCerts().connectTimeout(5000).userAgent(getString(R.string.USERAGENT)).header(HttpHeaders.COOKIE, this.f16008a);
                        ...
                        if (!asJsonObject2.getAsJsonObject("result").get("code").getAsString().equals("000")) {
                            ...
                            if (!jsonElement2.isJsonNull()) {
                                ...
                                if (jsonElement2.getAsJsonObject().get("drm_yn").getAsString().equals("Y")) {
                                    ...
                                    this.f16012e = asJsonObject2.getAsJsonObject("stream").get("drm_license_assertion").getAsString();
                                    this.f16011d = asJsonObject2.getAsJsonObject("stream").getAsJsonArray("drm_license_server_list").get(2).getAsString();
                                } else {
                            ...
                            if (asString2.contains("/manifest")) {
                                this.f16009b = asString2.concat(".mpd?content_type=LIVE");
                                if (channelData.getQualityType() == SettingsData.TvingQualityType.FHD.ordinal()) {
                                    if (this.f16009b.contains("live2000")) {
                                        this.f16009b = this.f16009b.replace("live2000", "live5000");
                                    } else if (this.f16009b.contains("live1500")) {
                                        this.f16009b = this.f16009b.replace("live1500", "live5000");
                                    }
                                }
                            } else {
                                try {
                                    String[] tvingDecrypt = PlayerActivity.tvingDecrypt(id, str3);
                                    this.f16009b = tvingDecrypt[0];
                                    this.f16010c = tvingDecrypt[1];
                                } catch (Exception unused2) {
                                    this.f16009b = "";
                                    this.f16010c = "";
                                }
                            }
                            String str6 = this.f16009b;
                            if (str6 != null && !str6.equals("null") && this.f16009b.length() != 0) {
                                if (this.f16009b.contains("live500.smil")) {
                                    channelData.setResolution(str2);
                                } else if (this.f16009b.contains("live1000.smil")) {
                                    channelData.setResolution(str);
                                } else if (!this.f16009b.contains("live1500.smil") && !this.f16009b.contains("live2000.smil")) {
                                    channelData.setResolution("FHD");
                                } else {
                                    channelData.setResolution("HD");
                                }
    ...
    public final void onPostExecute(BackgroundTask.ProgressOrResult progressOrResult) {
        ...
        if (activity != null && !activity.isFinishing()) {
            ...
            bundle.putString(ImagesContract.URL, this.f16009b);
            bundle.putString("cookie", this.f16010c);
            bundle.putString("drmserver", this.f16011d);
            bundle.putString("drmassert", this.f16012e);
            Date date = this.f16013f;
            if (date != null) {
