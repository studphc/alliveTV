...
public abstract class TvBaseRowsSupportFragment extends RowsSupportFragment implements OnItemViewSelectedListener {
    ...
    /* renamed from: B0 */
    public final ActivityResultLauncher f15952B0 = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new C1294i5(22, this));
    ...
    public void onItemSelected(Presenter.ViewHolder viewHolder, Object obj, RowPresenter.ViewHolder viewHolder2, Row row) {
        ...
        viewHolder.view.setOnLongClickListener(new ViewOnLongClickListenerC1092z(this, viewHolder, obj, viewHolder2, row));
        viewHolder.view.setOnKeyListener(new ViewOnKeyListenerC1065a0(this));
