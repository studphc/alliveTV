...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    /* renamed from: a */
    public static final int f18488a = Math.max(1, Integer.getInteger("rx3.buffer-size", 128).intValue());
    ...
    public static <T> Flowable<T> fromObservable(@NonNull ObservableSource<T> observableSource, @NonNull BackpressureStrategy backpressureStrategy) {
        ...
        int i = ni0.f23370a[backpressureStrategy.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i != 4) {
    ...
    public static <T> Flowable<T> fromOptional(@NonNull Optional<T> optional) {
        ...
        map = optional.map(new li0(0));
        orElseGet = map.orElseGet(new mi0(0));
    ...
    public static Flowable<Integer> range(int i, int i2) {
        ...
        throw new IllegalArgumentException(ye0.m8291k(i2, "count >= 0 required but it was "));
    }
    ...
    public static Flowable<Long> rangeLong(long j, long j2) {
        ...
        throw new IllegalArgumentException(ye0.m8294n(j2, "count >= 0 required but it was "));
    }
    ...
    /* renamed from: a */
    public final Flowable m5255a(Consumer consumer, Consumer consumer2, Action action, Action action2) {
    ...
    /* renamed from: b */
    public final Flowable m5256b(Function function, int i, boolean z) {
    ...
    /* renamed from: c */
    public final Flowable m5257c(long j, TimeUnit timeUnit, Scheduler scheduler, Publisher publisher) {
    ...
    /* renamed from: d */
    public final Flowable m5258d(Publisher publisher, Function function, Publisher publisher2) {
    ...
    public final Flowable<T> doAfterTerminate(@NonNull Action action) {
        return m5255a(Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.EMPTY_ACTION, action);
    }
    ...
    public final Flowable<T> doOnComplete(@NonNull Action action) {
        return m5255a(Functions.emptyConsumer(), Functions.emptyConsumer(), action, Functions.EMPTY_ACTION);
    }
    ...
    public final Flowable<T> doOnEach(@NonNull Consumer<? super Notification<T>> consumer) {
        ...
        return m5255a(Functions.notificationOnNext(consumer), Functions.notificationOnError(consumer), Functions.notificationOnComplete(consumer), Functions.EMPTY_ACTION);
    }
    ...
    public final Flowable<T> doOnError(@NonNull Consumer<? super Throwable> consumer) {
        ...
        return m5255a(emptyConsumer, consumer, action, action);
    }
    ...
    public final Flowable<T> doOnNext(@NonNull Consumer<? super T> consumer) {
        Consumer emptyConsumer = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return m5255a(consumer, emptyConsumer, action, action);
    }
    ...
    public final Flowable<T> doOnTerminate(@NonNull Action action) {
        return m5255a(Functions.emptyConsumer(), Functions.actionConsumer(action), action, Functions.EMPTY_ACTION);
    }
    ...
    public final Maybe<T> elementAt(long j) {
        ...
        throw new IndexOutOfBoundsException(ye0.m8294n(j, "index >= 0 required but it was "));
    }
    ...
    public final CompletionStage<T> firstOrErrorStage() {
        return AbstractC1608o3.m6428p(subscribeWith(new FlowableFirstStageSubscriber(false, null)));
    }
    ...
    public final CompletionStage<T> firstStage(@Nullable T t) {
        return AbstractC1608o3.m6428p(subscribeWith(new FlowableFirstStageSubscriber(true, t)));
    }
    ...
    public final CompletionStage<T> lastOrErrorStage() {
        return AbstractC1608o3.m6428p(subscribeWith(new FlowableLastStageSubscriber(false, null)));
    }
    ...
    public final CompletionStage<T> lastStage(@Nullable T t) {
        return AbstractC1608o3.m6428p(subscribeWith(new FlowableLastStageSubscriber(true, t)));
    }
    ...
    public final CompletionStage<T> singleOrErrorStage() {
        return AbstractC1608o3.m6428p(subscribeWith(new FlowableSingleStageSubscriber(false, null)));
    }
    ...
    public final CompletionStage<T> singleStage(@Nullable T t) {
        return AbstractC1608o3.m6428p(subscribeWith(new FlowableSingleStageSubscriber(true, t)));
    }
    ...
    public final Flowable<T> skip(long j) {
        if (j < 0) {
            throw new IllegalArgumentException(ye0.m8294n(j, "count >= 0 expected but it was "));
        }
        if (j == 0) {
    ...
    public final Flowable<T> skipLast(int i) {
        if (i < 0) {
            throw new IllegalArgumentException(ye0.m8291k(i, "count >= 0 required but it was "));
        }
        if (i == 0) {
            return RxJavaPlugins.onAssembly(this);
        }
    ...
    public final Flowable<T> take(long j) {
        ...
        throw new IllegalArgumentException(ye0.m8294n(j, "count >= 0 required but it was "));
    }
    ...
    public final <V> Flowable<T> timeout(@NonNull Function<? super T, ? extends Publisher<V>> function) {
        return m5258d(null, function, null);
    }
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    /* renamed from: to */
    public final <R> R m5259to(@NonNull FlowableConverter<T, ? extends R> flowableConverter) {
    ...
    public final Stream<T> blockingStream(int i) {
        ...
        disposable.getClass();
        onClose = stream.onClose(new RunnableC0006a5(17, disposable));
        return ki0.m5549q(onClose);
    }
    ...
    public final Flowable<T> repeat(long j) {
        if (j < 0) {
            throw new IllegalArgumentException(ye0.m8294n(j, "times >= 0 required but it was "));
        }
        if (j == 0) {
            return empty();
        }
    ...
    public final <R> Flowable<R> switchMap(@NonNull Function<? super T, ? extends Publisher<? extends R>> function, int i) {
        return m5256b(function, i, false);
    }
    ...
    public final <V> Flowable<T> timeout(@NonNull Function<? super T, ? extends Publisher<V>> function, @NonNull Publisher<? extends T> publisher) {
        Objects.requireNonNull(publisher, "fallback is null");
        return m5258d(null, function, publisher);
    }
    ...
    public final Flowable<T> timeout(long j, @NonNull TimeUnit timeUnit) {
        return m5257c(j, timeUnit, Schedulers.computation(), null);
    }
    ...
    public final Flowable<T> timeout(long j, @NonNull TimeUnit timeUnit, @NonNull Publisher<? extends T> publisher) {
        Objects.requireNonNull(publisher, "fallback is null");
        return m5257c(j, timeUnit, Schedulers.computation(), publisher);
    }
    ...
    public final Flowable<T> doOnEach(@NonNull Subscriber<? super T> subscriber) {
        Objects.requireNonNull(subscriber, "subscriber is null");
        return m5255a(FlowableInternalHelper.subscriberOnNext(subscriber), FlowableInternalHelper.subscriberOnError(subscriber), FlowableInternalHelper.subscriberOnComplete(subscriber), Functions.EMPTY_ACTION);
    }
    ...
    public final Flowable<T> timeout(long j, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler, @NonNull Publisher<? extends T> publisher) {
        Objects.requireNonNull(publisher, "fallback is null");
        return m5257c(j, timeUnit, scheduler, publisher);
    }
    ...
    public final Flowable<T> timeout(long j, @NonNull TimeUnit timeUnit, @NonNull Scheduler scheduler) {
        return m5257c(j, timeUnit, scheduler, null);
    }
    ...
    public final <U, V> Flowable<T> timeout(@NonNull Publisher<U> publisher, @NonNull Function<? super T, ? extends Publisher<V>> function) {
        ...
        return m5258d(publisher, function, null);
    }
    ...
    public final <U, V> Flowable<T> timeout(@NonNull Publisher<U> publisher, @NonNull Function<? super T, ? extends Publisher<V>> function, @NonNull Publisher<? extends T> publisher2) {
        ...
        return m5258d(publisher, function, publisher2);
    }
