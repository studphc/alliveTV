...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public static <T> Maybe<T> fromOptional(@NonNull Optional<T> optional) {
        ...
        map = optional.map(new li0(1));
        orElseGet = map.orElseGet(new mi0(1));
    ...
    public final Maybe<T> doAfterTerminate(@NonNull Action action) {
        ...
        return RxJavaPlugins.onAssembly(new MaybePeek(this, emptyConsumer, emptyConsumer2, emptyConsumer3, action2, action, action2));
    }
    ...
    public abstract void subscribeActual(@NonNull MaybeObserver<? super T> maybeObserver);
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    /* renamed from: to */
    public final <R> R m5260to(@NonNull MaybeConverter<T, ? extends R> maybeConverter) {
    ...
    public final CompletionStage<T> toCompletionStage() {
        return fx0.m4864q(subscribeWith(new CompletionStageConsumer(false, null)));
    }
    ...
    public final CompletionStage<T> toCompletionStage(@Nullable T t) {
        return fx0.m4864q(subscribeWith(new CompletionStageConsumer(true, t)));
    }
