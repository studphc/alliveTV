...
public final class FlowableRepeatWhen<T> extends AbstractC1215g0 {

    /* renamed from: b */
    public final Function f18984b;

    public FlowableRepeatWhen(Flowable<T> flowable, Function<? super Flowable<Object>, ? extends Publisher<?>> function) {
        super(flowable);
        this.f18984b = function;
    }
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ...
        try {
            Object apply = this.f18984b.apply(serialized);
