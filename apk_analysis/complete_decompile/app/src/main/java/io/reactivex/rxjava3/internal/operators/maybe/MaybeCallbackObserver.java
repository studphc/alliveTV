...
public final class MaybeCallbackObserver<T> extends AtomicReference<Disposable> implements MaybeObserver<T>, Disposable, LambdaConsumerIntrospection {
    ...
    /* renamed from: a */
    public final Consumer f19121a;

    /* renamed from: b */
    public final Consumer f19122b;

    /* renamed from: c */
    public final Action f19123c;

    public MaybeCallbackObserver(Consumer<? super T> consumer, Consumer<? super Throwable> consumer2, Action action) {
        this.f19121a = consumer;
        this.f19122b = consumer2;
        this.f19123c = action;
    }
    ...
    public boolean hasCustomOnError() {
        if (this.f19122b != Functions.ON_ERROR_MISSING) {
            return true;
        }
        return false;
    }
