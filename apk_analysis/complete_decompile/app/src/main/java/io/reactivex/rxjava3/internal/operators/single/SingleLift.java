...
public final class SingleLift<T, R> extends Single<R> {
    ...
    /* renamed from: a */
    public final SingleSource f19785a;

    /* renamed from: b */
    public final SingleOperator f19786b;

    public SingleLift(SingleSource<T> singleSource, SingleOperator<? extends R, ? super T> singleOperator) {
        this.f19785a = singleSource;
        this.f19786b = singleOperator;
    }

    @Override // io.reactivex.rxjava3.core.Single
    public void subscribeActual(SingleObserver<? super R> singleObserver) {
        try {
            SingleObserver<? super T> apply = this.f19786b.apply(singleObserver);
            Objects.requireNonNull(apply, "The onLift returned a null SingleObserver");
            this.f19785a.subscribe(apply);
        } catch (Throwable th) {
