...
public final class QueueDrainHelper {
    /* renamed from: a */
    public static boolean m5302a(long j, Subscriber subscriber, Queue queue, AtomicLong atomicLong, BooleanSupplier booleanSupplier) {
        boolean z;
        boolean z2;
    ...
    */
    ...
    public static <T> void postComplete(Subscriber<? super T> subscriber, Queue<T> queue, AtomicLong atomicLong, BooleanSupplier booleanSupplier) {
        ...
        if (m5302a(atomicLong.get(), subscriber, queue, atomicLong, booleanSupplier)) {
            return;
        }
        do {
            j = atomicLong.get();
        ...
        if (j != 0) {
            m5302a(j2, subscriber, queue, atomicLong, booleanSupplier);
        }
    }
    ...
    public static <T> boolean postCompleteRequest(long j, Subscriber<? super T> subscriber, Queue<T> queue, AtomicLong atomicLong, BooleanSupplier booleanSupplier) {
        ...
        if (j2 == Long.MIN_VALUE) {
            m5302a(j | Long.MIN_VALUE, subscriber, queue, atomicLong, booleanSupplier);
            return true;
        }
        return false;
    }
