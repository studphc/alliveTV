...
public final class ComparisonsKt__ComparisonsKt$thenByDescending$1<T> implements Comparator {
    ...
    /* renamed from: a */
    public final /* synthetic */ Comparator f21060a;

    /* renamed from: b */
    public final /* synthetic */ Function1 f21061b;
    ...
    public ComparisonsKt__ComparisonsKt$thenByDescending$1(Comparator<T> comparator, Function1<? super T, ? extends Comparable<?>> function1) {
        this.f21060a = comparator;
        this.f21061b = function1;
    }

    @Override // java.util.Comparator
    public final int compare(T t, T t2) {
        int compare = this.f21060a.compare(t, t2);
        if (compare == 0) {
            Function1 function1 = this.f21061b;
            return AbstractC1919vr.compareValues((Comparable) function1.invoke(t2), (Comparable) function1.invoke(t));
        }
        return compare;
    }
}
