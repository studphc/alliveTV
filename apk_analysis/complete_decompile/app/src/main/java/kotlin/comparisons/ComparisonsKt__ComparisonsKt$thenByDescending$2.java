...
public final class ComparisonsKt__ComparisonsKt$thenByDescending$2<T> implements Comparator {
    ...
    /* renamed from: a */
    public final /* synthetic */ Comparator f21062a;

    /* renamed from: b */
    public final /* synthetic */ Comparator f21063b;

    /* renamed from: c */
    public final /* synthetic */ Function1 f21064c;
    ...
    public ComparisonsKt__ComparisonsKt$thenByDescending$2(Comparator<T> comparator, Comparator<Object> comparator2, Function1<? super T, Object> function1) {
        this.f21062a = comparator;
        this.f21063b = comparator2;
    ...
    public final int compare(T t, T t2) {
        int compare = this.f21062a.compare(t, t2);
        if (compare == 0) {
            Function1 function1 = this.f21064c;
            return this.f21063b.compare(function1.invoke(t2), function1.invoke(t));
        }
        return compare;
    }
}
