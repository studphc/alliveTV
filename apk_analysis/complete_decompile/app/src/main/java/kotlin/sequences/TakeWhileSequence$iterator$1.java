...
public final class TakeWhileSequence$iterator$1<T> implements Iterator<T>, KMappedMarker {
    ...
    /* renamed from: d */
    public final /* synthetic */ TakeWhileSequence f21320d;

    public TakeWhileSequence$iterator$1(TakeWhileSequence takeWhileSequence) {
        Sequence sequence;
        this.f21320d = takeWhileSequence;
        sequence = takeWhileSequence.f21315a;
        this.iterator = sequence.iterator();
        this.nextState = -1;
    }

    /* renamed from: a */
    public final void m5635a() {
        Function1 function1;
        Iterator it = this.iterator;
        if (it.hasNext()) {
            Object next = it.next();
            function1 = this.f21320d.f21316b;
