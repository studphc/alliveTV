...
public final class CoroutineExceptionHandlerKt {
    ...
    public static final Throwable handlerException(@NotNull Throwable th, @NotNull Throwable th2) {
        ...
        ha0.addSuppressed(runtimeException, th);
