...
public final class ActorKt {
    ...
    public static final <E> SendChannel<E> actor(@NotNull CoroutineScope coroutineScope, @NotNull CoroutineContext coroutineContext, int i, @NotNull CoroutineStart coroutineStart, @Nullable Function1<? super Throwable, Unit> function1, @NotNull Function2<? super ActorScope<E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        if (coroutineStart.isLazy()) {
            c1897v5 = new C1897v5(newCoroutineContext, Channel$default, false);
            c1897v5.f25055e = IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted(function2, c1897v5, c1897v5);
        } else {
            c1897v5 = new C1897v5(newCoroutineContext, Channel$default, true);
        }
        if (function1 != null) {
            c1897v5.invokeOnCompletion(function1);
        }
        c1897v5.start(coroutineStart, c1897v5, function2);
        return c1897v5;
    }
