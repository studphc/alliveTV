...
public final class ChannelKt {
    ...
    public static final <T> T m8863getOrElseWpGqRn0(@NotNull Object obj, @NotNull Function1<? super Throwable, ? extends T> function1) {
        if (obj instanceof ChannelResult.Failed) {
            return function1.invoke(ChannelResult.m8871exceptionOrNullimpl(obj));
        }
        return obj;
    }
    ...
    public static final <T> Object m8864onClosedWpGqRn0(@NotNull Object obj, @NotNull Function1<? super Throwable, Unit> function1) {
        if (obj instanceof ChannelResult.Closed) {
            function1.invoke(ChannelResult.m8871exceptionOrNullimpl(obj));
        }
        return obj;
    }
    ...
    public static final <T> Object m8865onFailureWpGqRn0(@NotNull Object obj, @NotNull Function1<? super Throwable, Unit> function1) {
        if (obj instanceof ChannelResult.Failed) {
            function1.invoke(ChannelResult.m8871exceptionOrNullimpl(obj));
        }
        return obj;
    ...
    public static final <T> Object m8866onSuccessWpGqRn0(@NotNull Object obj, @NotNull Function1<? super T, Unit> function1) {
        if (!(obj instanceof ChannelResult.Failed)) {
