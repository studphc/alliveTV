...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(@NotNull ReceiveChannel<? extends E> receiveChannel) {
            Object mo8861tryReceivePtdJZtk = receiveChannel.mo8861tryReceivePtdJZtk();
            if (ChannelResult.m8877isSuccessimpl(mo8861tryReceivePtdJZtk)) {
                return (E) ChannelResult.m8873getOrThrowimpl(mo8861tryReceivePtdJZtk);
            }
            Throwable m8871exceptionOrNullimpl = ChannelResult.m8871exceptionOrNullimpl(mo8861tryReceivePtdJZtk);
        ...
        */
        public static <E> Object receiveOrNull(@NotNull ReceiveChannel<? extends E> receiveChannel, @NotNull Continuation<? super E> continuation) {
            ...
            if (continuation instanceof C1418g) {
                C1418g c1418g2 = (C1418g) continuation;
                int i2 = c1418g2.f21502e;
                if ((i2 & Integer.MIN_VALUE) != 0) {
                    c1418g2.f21502e = i2 - Integer.MIN_VALUE;
                    c1418g = c1418g2;
                    Object obj = c1418g.f21501d;
                    ...
                    if (i == 0) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        c1418g.f21502e = 1;
                        mo8860receiveCatchingJP2dKIU = receiveChannel.mo8860receiveCatchingJP2dKIU(c1418g);
                        if (mo8860receiveCatchingJP2dKIU == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
                    return ChannelResult.m8872getOrNullimpl(mo8860receiveCatchingJP2dKIU);
                }
            }
            c1418g = new ContinuationImpl(continuation);
            Object obj2 = c1418g.f21501d;
    ...
    Object mo8860receiveCatchingJP2dKIU(@NotNull Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo8861tryReceivePtdJZtk();
}
