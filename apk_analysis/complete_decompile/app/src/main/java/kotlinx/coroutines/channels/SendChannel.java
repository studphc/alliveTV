...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(@NotNull SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m8877isSuccessimpl(mo8858trySendJP2dKIU)) {
                return true;
            }
            Throwable m8871exceptionOrNullimpl = ChannelResult.m8871exceptionOrNullimpl(mo8858trySendJP2dKIU);
            if (m8871exceptionOrNullimpl == null) {
                return false;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m8871exceptionOrNullimpl);
        }
    }
    ...
    Object mo8858trySendJP2dKIU(E element);
}
