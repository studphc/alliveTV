...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3 implements Flow<Object> {
    ...
    /* renamed from: a */
    public final /* synthetic */ Iterable f21557a;

    @Metadata(m5570k = 3, m5571mv = {1, 8, 0}, m5573xi = 48)
    @DebugMetadata(m5600c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3", m5601f = "Builders.kt", m5602i = {0}, m5603l = {116}, m5604m = "collect", m5605n = {"$this$asFlow_u24lambda_u243"}, m5606s = {"L$0"})
    ...
    public static final class C14251 extends ContinuationImpl {
        ...
        /* renamed from: d */
        public /* synthetic */ Object f21558d;

        /* renamed from: e */
        public int f21559e;

        /* renamed from: g */
        public FlowCollector f21561g;

        /* renamed from: h */
        public Iterator f21562h;
    ...
    */
    public Object collect(@NotNull FlowCollector<? super Object> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C14251) {
            ...
            int i2 = c14251.f21559e;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                c14251.f21559e = i2 - Integer.MIN_VALUE;
                Object obj = c14251.f21558d;
                Object coroutine_suspended = b51.getCOROUTINE_SUSPENDED();
                i = c14251.f21559e;
                if (i == 0) {
                    if (i == 1) {
                        it = c14251.f21562h;
                        FlowCollector flowCollector3 = c14251.f21561g;
                    ...
                    it = this.f21557a.iterator();
                }
                while (it.hasNext()) {
                    Object next = it.next();
                    c14251.f21561g = flowCollector2;
                    c14251.f21562h = it;
                    c14251.f21559e = 1;
                    if (flowCollector2.emit(next, c14251) == coroutine_suspended) {
        ...
        c14251 = new C14251(continuation);
        Object obj2 = c14251.f21558d;
