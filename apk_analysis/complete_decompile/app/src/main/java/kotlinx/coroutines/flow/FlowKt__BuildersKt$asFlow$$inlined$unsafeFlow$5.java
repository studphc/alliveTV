...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5 implements Flow<Object> {
    ...
    /* renamed from: a */
    public final /* synthetic */ Sequence f21569a;

    @Metadata(m5570k = 3, m5571mv = {1, 8, 0}, m5573xi = 48)
    @DebugMetadata(m5600c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5", m5601f = "Builders.kt", m5602i = {0}, m5603l = {116}, m5604m = "collect", m5605n = {"$this$asFlow_u24lambda_u247"}, m5606s = {"L$0"})
    ...
    public static final class C14271 extends ContinuationImpl {
        ...
        /* renamed from: d */
        public /* synthetic */ Object f21570d;

        /* renamed from: e */
        public int f21571e;

        /* renamed from: g */
        public FlowCollector f21573g;

        /* renamed from: h */
        public Iterator f21574h;
    ...
    */
    public Object collect(@NotNull FlowCollector<? super Object> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C14271) {
            ...
            int i2 = c14271.f21571e;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                c14271.f21571e = i2 - Integer.MIN_VALUE;
                Object obj = c14271.f21570d;
                Object coroutine_suspended = b51.getCOROUTINE_SUSPENDED();
                i = c14271.f21571e;
                if (i == 0) {
                    if (i == 1) {
                        it = c14271.f21574h;
                        FlowCollector flowCollector3 = c14271.f21573g;
                    ...
                    it = this.f21569a.iterator();
                }
                while (it.hasNext()) {
                    Object next = it.next();
                    c14271.f21573g = flowCollector2;
                    c14271.f21574h = it;
                    c14271.f21571e = 1;
                    if (flowCollector2.emit(next, c14271) == coroutine_suspended) {
