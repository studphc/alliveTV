...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$7 implements Flow<Integer> {
    ...
    @DebugMetadata(m5600c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$7", m5601f = "Builders.kt", m5602i = {0, 0}, m5603l = {116}, m5604m = "collect", m5605n = {"$this$asFlow_u24lambda_u2413", "$this$forEach$iv"}, m5606s = {"L$0", "L$1"})
    ...
    public static final class C14291 extends ContinuationImpl {
        ...
        /* renamed from: d */
        public /* synthetic */ Object f21584d;

        /* renamed from: e */
        public int f21585e;

        /* renamed from: g */
        public FlowCollector f21587g;
    ...
    */
    public Object collect(@NotNull FlowCollector<? super Integer> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C14291) {
            ...
            int i4 = c14291.f21585e;
            if ((i4 & Integer.MIN_VALUE) != 0) {
                c14291.f21585e = i4 - Integer.MIN_VALUE;
                Object obj = c14291.f21584d;
                ...
                if (i == 0) {
                    if (i == 1) {
                        ...
                        i3 = c14291.f21589i;
                        iArr = c14291.f21588h;
                        FlowCollector flowCollector3 = c14291.f21587g;
                        ResultKt.throwOnFailure(obj);
                        flowCollector2 = flowCollector3;
                        i3++;
                        if (i3 < i2) {
                            Integer boxInt = Boxing.boxInt(iArr[i3]);
                            c14291.f21587g = flowCollector2;
                            c14291.f21588h = iArr;
                            c14291.f21589i = i3;
                            c14291.f21590j = i2;
                            c14291.f21585e = 1;
                            if (flowCollector2.emit(boxInt, c14291) == coroutine_suspended) {
