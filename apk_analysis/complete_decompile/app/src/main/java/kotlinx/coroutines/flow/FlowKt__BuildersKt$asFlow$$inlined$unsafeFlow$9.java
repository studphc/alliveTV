...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$9 implements Flow<Integer> {
    ...
    /* renamed from: a */
    public final /* synthetic */ IntRange f21599a;

    @Metadata(m5570k = 3, m5571mv = {1, 8, 0}, m5573xi = 48)
    @DebugMetadata(m5600c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$9", m5601f = "Builders.kt", m5602i = {0}, m5603l = {116}, m5604m = "collect", m5605n = {"$this$asFlow_u24lambda_u2417"}, m5606s = {"L$0"})
    ...
    public static final class C14311 extends ContinuationImpl {
        ...
        /* renamed from: d */
        public /* synthetic */ Object f21600d;

        /* renamed from: e */
        public int f21601e;

        /* renamed from: g */
        public FlowCollector f21603g;

        /* renamed from: h */
        public Iterator f21604h;
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            this.f21600d = obj;
            this.f21601e |= Integer.MIN_VALUE;
    ...
    */
    public Object collect(@NotNull FlowCollector<? super Integer> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C14311) {
            ...
            int i2 = c14311.f21601e;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                c14311.f21601e = i2 - Integer.MIN_VALUE;
                Object obj = c14311.f21600d;
                Object coroutine_suspended = b51.getCOROUTINE_SUSPENDED();
                i = c14311.f21601e;
                if (i == 0) {
                    if (i == 1) {
                        it = c14311.f21604h;
                        FlowCollector flowCollector3 = c14311.f21603g;
                    ...
                    it = this.f21599a.iterator();
                }
                while (it.hasNext()) {
                    Integer boxInt = Boxing.boxInt(((IntIterator) it).nextInt());
                    c14311.f21603g = flowCollector2;
                    c14311.f21604h = it;
                    c14311.f21601e = 1;
                    if (flowCollector2.emit(boxInt, c14311) == coroutine_suspended) {
