...
public final class FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1 implements Flow<Object> {
    ...
    /* renamed from: a */
    public final /* synthetic */ Flow f21786a;

    /* renamed from: b */
    public final /* synthetic */ Function2 f21787b;
    ...
    /* loaded from: classes2.dex */
    public static final class C14542<T> implements FlowCollector {

        /* renamed from: a */
        public final /* synthetic */ FlowCollector f21790a;

        /* renamed from: b */
        public final /* synthetic */ Function2 f21791b;

        @Metadata(m5570k = 3, m5571mv = {1, 8, 0}, m5573xi = CardPresenter.CARD_HEIGHT)
        @DebugMetadata(m5600c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1$2", m5601f = "Transform.kt", m5602i = {0, 0}, m5603l = {223, 223}, m5604m = "emit", m5605n = {"value", "$this$filterNot_u24lambda_u241"}, m5606s = {"L$0", "L$1"})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            /* renamed from: g */
            public Object f21795g;

            /* renamed from: h */
            public FlowCollector f21796h;
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                return C14542.this.emit(null, this);
            }
        }

        public C14542(FlowCollector flowCollector, Function2 function2) {
            this.f21790a = flowCollector;
            this.f21791b = function2;
        }
        ...
        */
        public final Object emit(T t, @NotNull Continuation<? super Unit> continuation) {
            ...
            if (continuation instanceof AnonymousClass1) {
                ...
                int i2 = anonymousClass1.f21793e;
                if ((i2 & Integer.MIN_VALUE) != 0) {
                    anonymousClass1.f21793e = i2 - Integer.MIN_VALUE;
                    obj = anonymousClass1.f21792d;
                    Object coroutine_suspended = b51.getCOROUTINE_SUSPENDED();
                    i = anonymousClass1.f21793e;
                    if (i == 0) {
                        if (i != 1) {
                            if (i == 2) {
                        ...
                        FlowCollector flowCollector2 = anonymousClass1.f21796h;
                        obj2 = anonymousClass1.f21795g;
                        ResultKt.throwOnFailure(obj);
                        flowCollector = flowCollector2;
                    } else {
                        ResultKt.throwOnFailure(obj);
                        anonymousClass1.f21795g = t;
                        FlowCollector flowCollector3 = this.f21790a;
                        anonymousClass1.f21796h = flowCollector3;
                        anonymousClass1.f21793e = 1;
                        Object invoke = this.f21791b.invoke(t, anonymousClass1);
                    ...
                    if (!((Boolean) obj).booleanValue()) {
                        anonymousClass1.f21795g = null;
                        anonymousClass1.f21796h = null;
                        anonymousClass1.f21793e = 2;
        ...
        public final Object emit$$forInline(Object obj, @NotNull Continuation continuation) {
            ...
            InlineMarker.mark(5);
            if (!((Boolean) this.f21791b.invoke(obj, continuation)).booleanValue()) {
                InlineMarker.mark(0);
                this.f21790a.emit(obj, continuation);
                InlineMarker.mark(1);
            }
            return Unit.INSTANCE;
        }
    ...
    public FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1(Flow flow, Function2 function2) {
        this.f21786a = flow;
        this.f21787b = function2;
    }

    @Override // kotlinx.coroutines.flow.Flow
    @Nullable
    public Object collect(@NotNull FlowCollector<? super Object> flowCollector, @NotNull Continuation continuation) {
        Object collect = this.f21786a.collect(new C14542(flowCollector, this.f21787b), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        InlineMarker.mark(5);
        C14542 c14542 = new C14542(flowCollector, this.f21787b);
        InlineMarker.mark(0);
        this.f21786a.collect(c14542, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
