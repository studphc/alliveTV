...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1 implements Flow<Object> {
    ...
    /* renamed from: a */
    public final /* synthetic */ Flow[] f21912a;

    /* renamed from: b */
    public final /* synthetic */ Function2 f21913b;

    public FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1(Flow[] flowArr, Function2 function2) {
        this.f21912a = flowArr;
        this.f21913b = function2;
    }
    ...
    public Object collect(@NotNull FlowCollector<? super Object> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        ...
        Object combineInternal = CombineKt.combineInternal(flowCollector, this.f21912a, C2026yn.f29028e, new FlowKt__ZipKt$combineUnsafe$1$1(this.f21913b, null), continuation);
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        InlineMarker.mark(5);
        Intrinsics.needClassReification();
        FlowKt__ZipKt$combineUnsafe$1$1 flowKt__ZipKt$combineUnsafe$1$1 = new FlowKt__ZipKt$combineUnsafe$1$1(this.f21913b, null);
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, this.f21912a, C2026yn.f29028e, flowKt__ZipKt$combineUnsafe$1$1, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
