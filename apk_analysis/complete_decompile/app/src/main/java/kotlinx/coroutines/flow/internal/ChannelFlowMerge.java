...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    public String additionalToStringProps() {
        return "concurrency=" + this.f21983b;
    }

    @Override // kotlinx.coroutines.flow.internal.ChannelFlow
    @Nullable
    public Object collectTo(@NotNull ProducerScope<? super T> producerScope, @NotNull Continuation<? super Unit> continuation) {
        Object collect = this.f21982a.collect(new C1127dm((Job) continuation.getContext().get(Job.INSTANCE), SemaphoreKt.Semaphore$default(this.f21983b, 0, 2, null), producerScope, new SendingCollector(producerScope)), continuation);
    ...
    public ChannelFlow<T> create(@NotNull CoroutineContext context, int capacity, @NotNull BufferOverflow onBufferOverflow) {
        return new ChannelFlowMerge(this.f21982a, this.f21983b, context, capacity, onBufferOverflow);
    }
