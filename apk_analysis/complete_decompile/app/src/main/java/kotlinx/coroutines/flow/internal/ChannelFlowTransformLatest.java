...
public final class ChannelFlowTransformLatest<T, R> extends ChannelFlowOperator<T, R> {
    ...
    public static final /* synthetic */ Function3 access$getTransform$p(ChannelFlowTransformLatest channelFlowTransformLatest) {
        return channelFlowTransformLatest.f21984a;
    }
    ...
    public ChannelFlow<R> create(@NotNull CoroutineContext context, int capacity, @NotNull BufferOverflow onBufferOverflow) {
        return new ChannelFlowTransformLatest(this.f21984a, this.flow, context, capacity, onBufferOverflow);
    }
    ...
    public Object flowCollect(@NotNull FlowCollector<? super R> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        Object coroutineScope = CoroutineScopeKt.coroutineScope(new C1480a(this, flowCollector, null), continuation);
