...
public final class Android10Platform extends Platform {
    ...
    /* renamed from: d */
    public static final boolean f24537d;

    /* renamed from: c */
    public final ArrayList f24538c;

    @Metadata(m5568d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u0004\u0018\u00010\u0002¢\u0006\u0004\b\u0003\u0010\u0004R\u0017\u0010\u0006\u001a\u00020\u00058\u0006¢\u0006\f\n\u0004\b\u0006\u0010\u0007\u001a\u0004\b\u0006\u0010\b¨\u0006\t"}, m5569d2 = {"Lokhttp3/internal/platform/Android10Platform$Companion;", "", "Lokhttp3/internal/platform/Platform;", "buildIfSupported", "()Lokhttp3/internal/platform/Platform;", "", "isSupported", "Z", "()Z", "okhttp"}, m5570k = 1, m5571mv = {1, 6, 0}, m5573xi = 48)
    /* loaded from: classes2.dex */
    public static final class Companion {
        ...
        public final boolean isSupported() {
            return Android10Platform.f24537d;
        }
    }
    ...
    public void configureTlsExtensions(@NotNull SSLSocket sslSocket, @Nullable String hostname, @NotNull List<? extends Protocol> protocols) {
        ...
        Iterator it = this.f24538c.iterator();
        while (true) {
            if (it.hasNext()) {
                obj = it.next();
    ...
    public Object getStackTraceForCloseable(@NotNull String closer) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            CloseGuard m6806c = AbstractC1673p3.m6806c();
            m6806c.open(closer);
            return m6806c;
        }
    ...
    public void logCloseableLeak(@NotNull String message, @Nullable Object stackTrace) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            if (stackTrace != null) {
                AbstractC1673p3.m6807d(stackTrace).warnIfOpen();
                return;
            }
