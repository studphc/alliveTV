...
public final class C1329is extends AtomicReference implements CompletableEmitter, Disposable {
    private static final long serialVersionUID = -2467358622224974244L;

    /* renamed from: a */
    public final CompletableObserver f20244a;

    public C1329is(CompletableObserver completableObserver) {
        this.f20244a = completableObserver;
    }
    ...
    public final String toString() {
        return C1329is.class.getSimpleName() + "{" + super.toString() + "}";
    }
