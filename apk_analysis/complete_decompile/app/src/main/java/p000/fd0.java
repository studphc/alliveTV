...
public abstract class fd0 extends dd0 {
        ...
        try {
            ...
            if (length <= 2147483647L) {
                ...
                if (i2 > 0) {
                    ...
                    if (read2 != -1) {
                        C1533m2 c1533m2 = new C1533m2(8193, 1);
                        c1533m2.write(read2);
                        ByteStreamsKt.copyTo$default(fileInputStream, c1533m2, 0, 2, null);
                        int size = c1533m2.size() + i;
                        if (size >= 0) {
                            byte[] m6005b = c1533m2.m6005b();
                            byte[] copyOf = Arrays.copyOf(bArr, size);
                            Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
                            bArr = ArraysKt___ArraysJvmKt.copyInto(m6005b, copyOf, i, 0, c1533m2.size());
                        } else {
    ...
    public static final List<String> readLines(@NotNull File file, @NotNull Charset charset) {
        ...
        forEachLine(file, charset, new ed0(arrayList, 0));
        return arrayList;
    }
    ...
    public static final void forEachBlock(@NotNull File file, int i, @NotNull Function2<? super byte[], ? super Integer, Unit> action) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        ?? r2 = new byte[r82.coerceAtLeast(i, 512)];
        FileInputStream fileInputStream = new FileInputStream(file);
        while (true) {
            try {
