...
public abstract class gc2 extends Resources {

    /* renamed from: a */
    public final Resources f17645a;

    public gc2(Resources resources) {
        super(resources.getAssets(), resources.getDisplayMetrics(), resources.getConfiguration());
        this.f17645a = resources;
    }

    /* renamed from: a */
    public final Drawable m4936a(int i) {
    ...
    public Drawable getDrawableForDensity(int i, int i2) {
        return ResourcesCompat.getDrawableForDensity(this.f17645a, i, i2, null);
    }
    ...
    public void getValue(int i, TypedValue typedValue, boolean z) {
        this.f17645a.getValue(i, typedValue, z);
    }

    @Override // android.content.res.Resources
    public void getValueForDensity(int i, int i2, TypedValue typedValue, boolean z) {
        this.f17645a.getValueForDensity(i, i2, typedValue, z);
    }
    ...
    public void parseBundleExtra(String str, AttributeSet attributeSet, Bundle bundle) {
        this.f17645a.parseBundleExtra(str, attributeSet, bundle);
    }

    @Override // android.content.res.Resources
    public void parseBundleExtras(XmlResourceParser xmlResourceParser, Bundle bundle) {
        this.f17645a.parseBundleExtras(xmlResourceParser, bundle);
    }

    @Override // android.content.res.Resources
    public void updateConfiguration(Configuration configuration, DisplayMetrics displayMetrics) {
        super.updateConfiguration(configuration, displayMetrics);
        Resources resources = this.f17645a;
        if (resources != null) {
    ...
    public void getValue(String str, TypedValue typedValue, boolean z) {
        this.f17645a.getValue(str, typedValue, z);
    }
