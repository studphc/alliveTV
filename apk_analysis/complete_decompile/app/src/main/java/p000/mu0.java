...
public final class mu0 extends FragmentTransitionImpl {
    /* renamed from: a */
    public static boolean m6258a(Transition transition) {
    ...
    public final void addTargets(Object obj, ArrayList arrayList) {
        ...
        if (!m6258a(transition) && FragmentTransitionImpl.isNullOrEmpty(transition.getTargets())) {
    ...
    public final void replaceTargets(Object obj, ArrayList arrayList, ArrayList arrayList2) {
        ...
        if (!m6258a(transition) && (targets = transition.getTargets()) != null && targets.size() == arrayList.size() && targets.containsAll(arrayList)) {
            if (arrayList2 == null) {
                size = 0;
            } else {
    ...
    public final void scheduleHideFragmentView(Object obj, View view, ArrayList arrayList) {
        ((Transition) obj).addListener(new ju0(view, arrayList));
    }
    ...
    public final void scheduleRemoveTargets(Object obj, Object obj2, ArrayList arrayList, Object obj3, ArrayList arrayList2, Object obj4, ArrayList arrayList3) {
        ((Transition) obj).addListener(new ku0(this, obj2, arrayList, obj3, arrayList2, obj4, arrayList3));
    }
    ...
    public final void setEpicenter(Object obj, View view) {
        if (view != null) {
            ...
            ((Transition) obj).setEpicenterCallback(new iu0(0, rect));
        }
    }
    ...
    public final void setListenerForTransitionEnd(Fragment fragment, Object obj, CancellationSignal cancellationSignal, Runnable runnable) {
        ((Transition) obj).addListener(new lu0(0, runnable));
    }
    ...
    public final void setEpicenter(Object obj, Rect rect) {
        if (obj != null) {
            ((Transition) obj).setEpicenterCallback(new iu0(1, rect));
        }
    }
}
