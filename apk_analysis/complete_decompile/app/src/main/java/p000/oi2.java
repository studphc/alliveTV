...
public final class oi2 extends AtomicReference implements SingleEmitter, Disposable {
    private static final long serialVersionUID = -2467358622224974244L;

    /* renamed from: a */
    public final SingleObserver f23817a;

    public oi2(SingleObserver singleObserver) {
        this.f23817a = singleObserver;
    }
    ...
    public final void onSuccess(Object obj) {
        ...
        if (obj2 != disposableHelper && (disposable = (Disposable) getAndSet(disposableHelper)) != disposableHelper) {
            SingleObserver singleObserver = this.f23817a;
            try {
                if (obj == null) {
    ...
    public final String toString() {
        return oi2.class.getSimpleName() + "{" + super.toString() + "}";
    }
