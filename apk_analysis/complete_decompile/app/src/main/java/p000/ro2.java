...
public abstract class ro2 extends qo2 {
    ...
    public static final boolean isBlank(@NotNull CharSequence charSequence) {
        ...
        if (charSequence.length() != 0) {
            ...
            if (!(indices instanceof Collection) || !((Collection) indices).isEmpty()) {
                ...
                while (it.hasNext()) {
                    if (!AbstractC1326ip.isWhitespace(charSequence.charAt(((IntIterator) it).nextInt()))) {
                        return false;
                    }
                }
            }
        ...
        if (i >= 0) {
            ...
            if (i != 1) {
                ...
                if (length != 1) {
                    ...
                    IntIterator m7068x = AbstractC1726qj.m7068x(1, i);
    ...
    public static final String replace(@NotNull String str, char c, char c2, boolean z) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (AbstractC1362jp.equals(charAt, c, z)) {
                charAt = c2;
            }
            sb.append(charAt);
        }
    ...
    public static final String replace(@NotNull String str, @NotNull String oldValue, @NotNull String newValue, boolean z) {
        ...
        int coerceAtLeast = r82.coerceAtLeast(length, 1);
