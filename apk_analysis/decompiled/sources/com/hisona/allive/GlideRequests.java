...
public class GlideRequests extends RequestManager {
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<Drawable> mo48load(@Nullable Bitmap bitmap) {
        return (GlideRequest) super.mo48load(bitmap);
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<Drawable> mo49load(@Nullable Drawable drawable) {
        return (GlideRequest) super.mo49load(drawable);
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<Drawable> mo54load(@Nullable String str) {
        return (GlideRequest) super.mo54load(str);
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<Drawable> mo50load(@Nullable Uri uri) {
        return (GlideRequest) super.mo50load(uri);
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<Drawable> mo51load(@Nullable File file) {
        return (GlideRequest) super.mo51load(file);
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<Drawable> mo52load(@Nullable @DrawableRes @RawRes Integer num) {
        return (GlideRequest) super.mo52load(num);
    }
    ...
    @Deprecated
    /* renamed from: load */
    public GlideRequest<Drawable> mo55load(@Nullable URL url) {
        return (GlideRequest) super.mo55load(url);
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<Drawable> mo56load(@Nullable byte[] bArr) {
        return (GlideRequest) super.mo56load(bArr);
    }
    ...
    @CheckResult
    /* renamed from: load */
    public GlideRequest<Drawable> mo53load(@Nullable Object obj) {
        return (GlideRequest) super.mo53load(obj);
    }
}
