...
public class SnsLoginDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        this.u0.setWebViewClient(new y(this));
        ...
        this.u0.requestFocus(TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
        this.u0.loadUrl("https://user.tving.com/oauth/oauthLogin.tving?target=naver&from=pc&rtUrl=https://www.tving.com/main.do?retRef=Y&source=https://user.tving.com/&csite=&isAuto=false");
